...
class ChnodebatteryIdPostRequest(BaseModel):
    """
    ChnodebatteryIdPostRequest
    """ # noqa: E501
    remove: Optional[StrictStr] = None
    battery: Optional[StrictStr] = None
    identify: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["remove", "battery", "identify"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChnodebatteryIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChnodebatteryIdPostRequest from a dict"""
        if obj is None:
            return None
