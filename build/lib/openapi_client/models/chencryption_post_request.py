...
class ChencryptionPostRequest(BaseModel):
    """
    ChencryptionPostRequest
    """ # noqa: E501
    usb: Optional[StrictStr] = None
    keyserver: Optional[StrictStr] = None
    recoverykey: Optional[StrictStr] = None
    key: Optional[StrictStr] = None
    internal: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["usb", "keyserver", "recoverykey", "key", "internal"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChencryptionPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChencryptionPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "usb": obj.get("usb"),
            "keyserver": obj.get("keyserver"),
            "recoverykey": obj.get("recoverykey"),
            "key": obj.get("key"),
