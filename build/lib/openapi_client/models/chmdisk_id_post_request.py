...
class ChmdiskIdPostRequest(BaseModel):
    """
    ChmdiskIdPostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    tier: Optional[StrictInt] = None
    easytierload: Optional[StrictStr] = None
    encrypt: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["name", "tier", "easytierload", "encrypt"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChmdiskIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChmdiskIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "tier": obj.get("tier"),
            "easytierload": obj.get("easytierload"),
