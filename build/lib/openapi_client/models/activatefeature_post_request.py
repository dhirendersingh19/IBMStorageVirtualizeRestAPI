...
class ActivatefeaturePostRequest(BaseModel):
    """
    ActivatefeaturePostRequest
    """ # noqa: E501
    licensekey: Optional[StrictStr] = None
    licensekeyfile: Optional[StrictStr] = None
    trial: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["licensekey", "licensekeyfile", "trial"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ActivatefeaturePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ActivatefeaturePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "licensekeyfile": obj.get("licensekeyfile"),
            "trial": obj.get("trial")
        })
        return _obj
