...
class PrestartfcconsistgrpIdPostRequest(BaseModel):
    """
    PrestartfcconsistgrpIdPostRequest
    """ # noqa: E501
    restore: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["restore"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PrestartfcconsistgrpIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PrestartfcconsistgrpIdPostRequest from a dict"""
        if obj is None:
            return None
