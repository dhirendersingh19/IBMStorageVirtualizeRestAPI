...
class MkvolumegroupPostRequest(BaseModel):
    """
    MkvolumegroupPostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    ownershipgroup: Optional[StrictStr] = None
    safeguardedpolicy: Optional[StrictStr] = None
    policystarttime: Optional[StrictStr] = None
    replicationpolicy: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    fromsourcegroup: Optional[StrictStr] = None
    fromsourceuid: Optional[StrictInt] = None
    fromsnapshotid: Optional[StrictStr] = None
    fromsourcevolumes: Optional[StrictStr] = None
    snapshot: Optional[StrictStr] = None
    snapshotpolicy: Optional[StrictStr] = None
    safeguarded: Optional[StrictBool] = None
    pool: Optional[StrictStr] = None
    iogroup: Optional[StrictStr] = None
    ignoreuserfcmaps: Optional[StrictBool] = None
    partition: Optional[StrictStr] = None
    draftpartition: Optional[StrictStr] = None
    owner: Optional[StrictInt] = None
    nopartition: Optional[StrictBool] = None
    purpose1: Optional[StrictInt] = None
    purpose2: Optional[StrictInt] = None
    purpose3: Optional[StrictInt] = None
    purpose4: Optional[StrictInt] = None
    druserconfig: Optional[StrictBool] = None
    drusershadow: Optional[StrictBool] = None
    druserconfigdiverged: Optional[StrictBool] = None
    setpartitiondefault: Optional[StrictBool] = None
    issyncdr: Optional[StrictInt] = None
    snapshotbuffer: Optional[StrictBool] = None
    uuid: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "ownershipgroup", "safeguardedpolicy", "policystarttime", "replicationpolicy", "type", "fromsourcegroup", "fromsourceuid", "fromsnapshotid", "fromsourcevolumes", "snapshot", "snapshotpolicy", "safeguarded", "pool", "iogroup", "ignoreuserfcmaps", "partition", "draftpartition", "owner", "nopartition", "purpose1", "purpose2", "purpose3", "purpose4", "druserconfig", "drusershadow", "druserconfigdiverged", "setpartitiondefault", "issyncdr", "snapshotbuffer", "uuid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkvolumegroupPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkvolumegroupPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "ownershipgroup": obj.get("ownershipgroup"),
            "safeguardedpolicy": obj.get("safeguardedpolicy"),
            "policystarttime": obj.get("policystarttime"),
            "replicationpolicy": obj.get("replicationpolicy"),
            "type": obj.get("type"),
            "fromsourcegroup": obj.get("fromsourcegroup"),
            "fromsourceuid": obj.get("fromsourceuid"),
            "fromsnapshotid": obj.get("fromsnapshotid"),
            "fromsourcevolumes": obj.get("fromsourcevolumes"),
            "snapshot": obj.get("snapshot"),
            "snapshotpolicy": obj.get("snapshotpolicy"),
            "safeguarded": obj.get("safeguarded"),
            "pool": obj.get("pool"),
            "iogroup": obj.get("iogroup"),
            "ignoreuserfcmaps": obj.get("ignoreuserfcmaps"),
            "partition": obj.get("partition"),
            "draftpartition": obj.get("draftpartition"),
            "owner": obj.get("owner"),
            "nopartition": obj.get("nopartition"),
            "purpose1": obj.get("purpose1"),
            "purpose2": obj.get("purpose2"),
            "purpose3": obj.get("purpose3"),
            "purpose4": obj.get("purpose4"),
            "druserconfig": obj.get("druserconfig"),
            "drusershadow": obj.get("drusershadow"),
            "druserconfigdiverged": obj.get("druserconfigdiverged"),
            "setpartitiondefault": obj.get("setpartitiondefault"),
            "issyncdr": obj.get("issyncdr"),
            "snapshotbuffer": obj.get("snapshotbuffer"),
            "uuid": obj.get("uuid")
        })
        return _obj
