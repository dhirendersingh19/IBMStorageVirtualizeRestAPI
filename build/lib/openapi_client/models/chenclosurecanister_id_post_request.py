...
class ChenclosurecanisterIdPostRequest(BaseModel):
    """
    ChenclosurecanisterIdPostRequest
    """ # noqa: E501
    identify: Optional[StrictStr] = None
    excludesasport: Optional[StrictStr] = None
    port: Optional[StrictStr] = None
    reset: Optional[StrictStr] = None
    canister: Optional[StrictStr] = None
    boot: Optional[StrictStr] = None
    force: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["identify", "excludesasport", "port", "reset", "canister", "boot", "force"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChenclosurecanisterIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChenclosurecanisterIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "excludesasport": obj.get("excludesasport"),
            "port": obj.get("port"),
            "reset": obj.get("reset"),
            "canister": obj.get("canister"),
            "boot": obj.get("boot"),
            "force": obj.get("force")
        })
        return _obj
