...
class MkhostPostRequest(BaseModel):
    """
    MkhostPostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    fcwwpn: Optional[StrictStr] = None
    fdminame: Optional[StrictStr] = None
    saswwpn: Optional[StrictStr] = None
    force: Optional[StrictBool] = None
    type: Optional[StrictInt] = None
    iogrp: Optional[StrictStr] = None
    iscsiname: Optional[StrictStr] = None
    hostcluster: Optional[StrictStr] = None
    protocol: Optional[StrictStr] = None
    nqn: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["name", "fcwwpn", "fdminame", "saswwpn", "force", "type", "iogrp", "iscsiname", "hostcluster", "protocol", "nqn", "ownershipgroup", "portset", "autostoragediscovery", "partition", "forceautozone", "location", "uuid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkhostPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkhostPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "fcwwpn": obj.get("fcwwpn"),
            "fdminame": obj.get("fdminame"),
            "saswwpn": obj.get("saswwpn"),
            "force": obj.get("force"),
            "type": obj.get("type"),
            "iogrp": obj.get("iogrp"),
            "iscsiname": obj.get("iscsiname"),
            "hostcluster": obj.get("hostcluster"),
