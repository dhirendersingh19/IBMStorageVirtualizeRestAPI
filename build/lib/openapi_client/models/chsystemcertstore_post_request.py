...
class ChsystemcertstorePostRequest(BaseModel):
    """
    ...
    exportrootca: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["scope", "cancel", "autorenew", "install", "file", "export", "exportrootca"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChsystemcertstorePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChsystemcertstorePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "exportrootca": obj.get("exportrootca")
        })
        return _obj
