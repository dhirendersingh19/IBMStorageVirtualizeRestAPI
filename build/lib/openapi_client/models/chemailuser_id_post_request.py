...
class ChemailuserIdPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "address", "error", "warning", "info", "usertype", "inventory"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChemailuserIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChemailuserIdPostRequest from a dict"""
        if obj is None:
            return None
