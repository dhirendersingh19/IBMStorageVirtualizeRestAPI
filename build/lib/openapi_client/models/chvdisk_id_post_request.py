...
class ChvdiskIdPostRequest(BaseModel):
    """
    ...
    unitmb: Optional[StrictStr] = None
    ...
    novolumegroup: Optional[StrictBool] = None
    retainbackupenabled: Optional[StrictStr] = None
    backup: Optional[StrictStr] = None
    enable: Optional[StrictStr] = None
    disable: Optional[StrictStr] = None
    account: Optional[StrictStr] = None
    backupgrainsize: Optional[StrictStr] = None
    displayname: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "rate", "force", "unitmb", "udid", "warning", "unit", "autoexpand", "copy", "primary", "syncrate", "cache", "easytier", "mirrorwritepriority", "volumegroup", "novolumegroup", "retainbackupenabled", "backup", "enable", "disable", "account", "backupgrainsize", "displayname"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChvdiskIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChvdiskIdPostRequest from a dict"""
        if obj is None:
            return None
