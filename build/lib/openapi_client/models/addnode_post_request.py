...
class AddnodePostRequest(BaseModel):
    """
    AddnodePostRequest
    """ # noqa: E501
    wwnodename: Optional[StrictStr] = None
    iogrp: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    panelname: Optional[StrictStr] = None
    site: Optional[StrictStr] = None
    spare: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["wwnodename", "iogrp", "name", "panelname", "site", "spare"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddnodePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddnodePostRequest from a dict"""
        if obj is None:
            return None
