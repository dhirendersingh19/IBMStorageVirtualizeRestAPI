...
class ChrcconsistgrpIdPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "cyclingmode", "cycleperiodseconds", "global", "metro"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChrcconsistgrpIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChrcconsistgrpIdPostRequest from a dict"""
        if obj is None:
            return None
