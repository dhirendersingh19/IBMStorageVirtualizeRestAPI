...
class MkvolumehostclustermapIdPostRequest(BaseModel):
    """
    MkvolumehostclustermapIdPostRequest
    """ # noqa: E501
    hostcluster: Optional[StrictStr] = None
    scsi: Optional[StrictInt] = None
    force: Optional[StrictBool] = None
    allowmismatchedscsiids: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["hostcluster", "scsi", "force", "allowmismatchedscsiids"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkvolumehostclustermapIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkvolumehostclustermapIdPostRequest from a dict"""
        if obj is None:
            return None
