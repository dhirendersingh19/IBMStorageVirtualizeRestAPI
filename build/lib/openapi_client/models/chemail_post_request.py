...
class ChemailPostRequest(BaseModel):
    """
    ChemailPostRequest
    """ # noqa: E501
    ...
    nocontact2: Optional[StrictStr] = None
    contact2: Optional[StrictStr] = None
    primary2: Optional[StrictStr] = None
    alternate2: Optional[StrictStr] = None
    ...
    nofrom: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["reply", "contact", "primary", "alternate", "location", "nocontact2", "contact2", "primary2", "alternate2", "organization", "address", "city", "state", "zip", "country", "from", "nofrom"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChemailPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChemailPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "nocontact2": obj.get("nocontact2"),
            "contact2": obj.get("contact2"),
            "primary2": obj.get("primary2"),
            "alternate2": obj.get("alternate2"),
