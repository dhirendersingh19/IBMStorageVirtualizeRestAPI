...
class ChvolumegroupIdPostRequest(BaseModel):
    """
    ChvolumegroupIdPostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    ownershipgroup: Optional[StrictStr] = None
    noownershipgroup: Optional[StrictBool] = None
    safeguardedpolicy: Optional[StrictStr] = None
    nosafeguardedpolicy: Optional[StrictBool] = None
    ...
    nosnapshotpolicy: Optional[StrictBool] = None
    draftpartition: Optional[StrictStr] = None
    nodraftpartition: Optional[StrictBool] = None
    ignoreuserfcmaps: Optional[StrictInt] = None
    snapshotbuffer: Optional[StrictInt] = None
    retainbackupenabled: Optional[StrictBool] = None
    nodrreplication: Optional[StrictBool] = None
    issyncdr: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["name", "ownershipgroup", "noownershipgroup", "safeguardedpolicy", "nosafeguardedpolicy", "policystarttime", "replicationpolicy", "purpose1", "purpose2", "purpose3", "purpose4", "druserconfig", "drusershadow", "druserconfigdiverged", "snapshotpolicy", "safeguarded", "nosnapshotpolicy", "draftpartition", "nodraftpartition", "ignoreuserfcmaps", "snapshotbuffer", "retainbackupenabled", "nodrreplication", "issyncdr"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChvolumegroupIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChvolumegroupIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "noownershipgroup": obj.get("noownershipgroup"),
            "safeguardedpolicy": obj.get("safeguardedpolicy"),
            "nosafeguardedpolicy": obj.get("nosafeguardedpolicy"),
            ...
            "nosnapshotpolicy": obj.get("nosnapshotpolicy"),
            "draftpartition": obj.get("draftpartition"),
            "nodraftpartition": obj.get("nodraftpartition"),
            "ignoreuserfcmaps": obj.get("ignoreuserfcmaps"),
            "snapshotbuffer": obj.get("snapshotbuffer"),
            "retainbackupenabled": obj.get("retainbackupenabled"),
            "nodrreplication": obj.get("nodrreplication"),
