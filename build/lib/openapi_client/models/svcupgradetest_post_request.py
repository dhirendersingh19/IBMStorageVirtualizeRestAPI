...
class SvcupgradetestPostRequest(BaseModel):
    """
    ...
    q: Optional[StrictBool] = None
    w: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["v", "n", "d", "f", "q", "w"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SvcupgradetestPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SvcupgradetestPostRequest from a dict"""
        if obj is None:
            return None
