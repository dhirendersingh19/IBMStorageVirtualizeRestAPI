...
class MkrcconsistgrpPostRequest(BaseModel):
    """
    MkrcconsistgrpPostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    cluster: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "cluster"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkrcconsistgrpPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkrcconsistgrpPostRequest from a dict"""
        if obj is None:
            return None
