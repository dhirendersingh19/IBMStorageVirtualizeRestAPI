...
class RmvdiskcopyIdPostRequest(BaseModel):
    """
    RmvdiskcopyIdPostRequest
    """ # noqa: E501
    copy: Optional[StrictInt] = None
    force: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["copy", "force"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RmvdiskcopyIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RmvdiskcopyIdPostRequest from a dict"""
        if obj is None:
            return None
