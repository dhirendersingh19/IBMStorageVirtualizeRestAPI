...
class ChenclosuresemIdPostRequest(BaseModel):
    """
    ChenclosuresemIdPostRequest
    """ # noqa: E501
    clearswap: Optional[StrictStr] = None
    sem: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["clearswap", "sem"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChenclosuresemIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChenclosuresemIdPostRequest from a dict"""
        if obj is None:
            return None
