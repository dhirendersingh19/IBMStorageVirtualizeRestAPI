...
class AddsnapshotPostRequest(BaseModel):
    """
    AddsnapshotPostRequest
    """ # noqa: E501
    volumegroup: Optional[StrictStr] = None
    volumes: Optional[StrictStr] = None
    parentuid: Optional[StrictInt] = None
    pool: Optional[StrictStr] = None
    prepare: Optional[StrictBool] = None
    ignorelegacy: Optional[StrictBool] = None
    trigger: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    safeguarded: Optional[StrictBool] = None
    triggerid: Optional[StrictInt] = None
    retentiondays: Optional[StrictInt] = None
    retentionminutes: Optional[StrictInt] = None
    commitgenerationsnapshotid: Optional[StrictInt] = None
    uuid: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["volumegroup", "volumes", "parentuid", "pool", "prepare", "ignorelegacy", "trigger", "name", "safeguarded", "triggerid", "retentiondays", "retentionminutes", "commitgenerationsnapshotid", "uuid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddsnapshotPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddsnapshotPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "pool": obj.get("pool"),
            "prepare": obj.get("prepare"),
            "ignorelegacy": obj.get("ignorelegacy"),
            ...
            "commitgenerationsnapshotid": obj.get("commitgenerationsnapshotid"),
            "uuid": obj.get("uuid")
        })
        return _obj
