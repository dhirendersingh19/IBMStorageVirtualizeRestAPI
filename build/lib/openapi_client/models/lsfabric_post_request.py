...
class LsfabricPostRequest(BaseModel):
    """
    LsfabricPostRequest
    """ # noqa: E501
    node: Optional[StrictStr] = None
    port: Optional[StrictStr] = None
    wwpn: Optional[StrictStr] = None
    host: Optional[StrictStr] = None
    controller: Optional[StrictStr] = None
    cluster: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["node", "port", "wwpn", "host", "controller", "cluster"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LsfabricPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LsfabricPostRequest from a dict"""
        if obj is None:
            return None
