...
class SettimezonePostRequest(BaseModel):
    """
    SettimezonePostRequest
    """ # noqa: E501
    timezone: Optional[StrictInt] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SettimezonePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SettimezonePostRequest from a dict"""
        if obj is None:
            return None
