...
class RmportipIdPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["node", "ip_6", "failover"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RmportipIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RmportipIdPostRequest from a dict"""
        if obj is None:
            return None
