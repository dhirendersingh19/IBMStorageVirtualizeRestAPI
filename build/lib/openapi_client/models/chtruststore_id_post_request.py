...
class ChtruststoreIdPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["file", "name", "restapi", "ipsec", "email", "snmp", "syslog", "export"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChtruststoreIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChtruststoreIdPostRequest from a dict"""
        if obj is None:
            return None
