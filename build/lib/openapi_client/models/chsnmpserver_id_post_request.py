...
class ChsnmpserverIdPostRequest(BaseModel):
    """
    ...
    engineid: Optional[StrictStr] = None
    securityname: Optional[StrictStr] = None
    authprotocol: Optional[StrictStr] = None
    authpassphrase: Optional[StrictStr] = None
    privprotocol: Optional[StrictStr] = None
    privpassphrase: Optional[StrictStr] = None
    noauth: Optional[StrictStr] = None
    nopriv: Optional[StrictStr] = None
    tls: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "ip", "community", "error", "warning", "info", "port", "engineid", "securityname", "authprotocol", "authpassphrase", "privprotocol", "privpassphrase", "noauth", "nopriv", "tls"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChsnmpserverIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChsnmpserverIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "authpassphrase": obj.get("authpassphrase"),
            "privprotocol": obj.get("privprotocol"),
            "privpassphrase": obj.get("privpassphrase"),
            "noauth": obj.get("noauth"),
            "nopriv": obj.get("nopriv"),
            "tls": obj.get("tls")
        })
        return _obj
