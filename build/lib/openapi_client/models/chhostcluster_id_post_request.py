...
class ChhostclusterIdPostRequest(BaseModel):
    """
    ...
    convertcommonmappings: Optional[StrictBool] = None
    draftpartition: Optional[StrictStr] = None
    nodraftpartition: Optional[StrictBool] = None
    uniformconnectivity: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["name", "type", "site", "nosite", "force", "ownershipgroup", "noownershipgroup", "convertcommonmappings", "draftpartition", "nodraftpartition", "uniformconnectivity"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChhostclusterIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChhostclusterIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "convertcommonmappings": obj.get("convertcommonmappings"),
            "draftpartition": obj.get("draftpartition"),
            "nodraftpartition": obj.get("nodraftpartition"),
            "uniformconnectivity": obj.get("uniformconnectivity")
        })
        return _obj
