...
class DetectiscsistorageportcandidatePostRequest(BaseModel):
    """
    DetectiscsistorageportcandidatePostRequest
    """ # noqa: E501
    srcportid: Optional[StrictInt] = None
    targetip: Optional[StrictStr] = None
    targetip6: Optional[StrictStr] = None
    iogrp: Optional[StrictStr] = None
    username: Optional[StrictStr] = None
    chapsecret: Optional[StrictStr] = None
    site: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["srcportid", "targetip", "targetip6", "iogrp", "username", "chapsecret", "site"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DetectiscsistorageportcandidatePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DetectiscsistorageportcandidatePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "srcportid": obj.get("srcportid"),
            "targetip": obj.get("targetip"),
            "targetip6": obj.get("targetip6"),
            "iogrp": obj.get("iogrp"),
