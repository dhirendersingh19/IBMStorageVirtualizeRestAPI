...
class SvcsearchPostRequest(BaseModel):
    """
    SvcsearchPostRequest
    """ # noqa: E501
    objects: Optional[StrictStr] = None
    limit: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["objects", "limit"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SvcsearchPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SvcsearchPostRequest from a dict"""
        if obj is None:
            return None
