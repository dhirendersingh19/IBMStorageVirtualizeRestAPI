...
class ChkeyserverkeysecurePostRequest(BaseModel):
    """
    ChkeyserverkeysecurePostRequest
    """ # noqa: E501
    username: Optional[StrictStr] = None
    nousername: Optional[StrictBool] = None
    password: Optional[StrictStr] = None
    nopassword: Optional[StrictBool] = None
    sslcert: Optional[StrictStr] = None
    nosslcert: Optional[StrictBool] = None
    enable: Optional[StrictBool] = None
    disable: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["username", "nousername", "password", "nopassword", "sslcert", "nosslcert", "enable", "disable"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChkeyserverkeysecurePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChkeyserverkeysecurePostRequest from a dict"""
        if obj is None:
            return None
