...
class LsenclosureslotIdPostRequest(BaseModel):
    """
    LsenclosureslotIdPostRequest
    """ # noqa: E501
    filtervalue: Optional[StrictStr] = None
    slot: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["filtervalue", "slot"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LsenclosureslotIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LsenclosureslotIdPostRequest from a dict"""
        if obj is None:
            return None
