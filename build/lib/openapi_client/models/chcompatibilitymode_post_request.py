...
class ChcompatibilitymodePostRequest(BaseModel):
    """
    ChcompatibilitymodePostRequest
    """ # noqa: E501
    feature: Optional[StrictInt] = None
    enable: Optional[StrictBool] = None
    disable: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["feature", "enable", "disable"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChcompatibilitymodePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChcompatibilitymodePostRequest from a dict"""
        if obj is None:
            return None
