...
class ChlicensePostRequest(BaseModel):
    """
    ChlicensePostRequest
    """ # noqa: E501
    flash: Optional[StrictStr] = None
    remote: Optional[StrictStr] = None
    virtualization: Optional[StrictStr] = None
    physical_flash: Optional[StrictStr] = None
    compression: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["flash", "remote", "virtualization", "physical_flash", "compression"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChlicensePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChlicensePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "physical_flash": obj.get("physical_flash"),
