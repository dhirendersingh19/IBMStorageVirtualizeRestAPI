...
class LsvolumegroupsnapshotPostRequest(BaseModel):
    """
    LsvolumegroupsnapshotPostRequest
    """ # noqa: E501
    filtervalue: Optional[StrictStr] = None
    volumegroup: Optional[StrictStr] = None
    parentuid: Optional[StrictStr] = None
    snapshot: Optional[StrictStr] = None
    unit: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["filtervalue", "volumegroup", "parentuid", "snapshot", "unit"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LsvolumegroupsnapshotPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LsvolumegroupsnapshotPostRequest from a dict"""
        if obj is None:
            return None
