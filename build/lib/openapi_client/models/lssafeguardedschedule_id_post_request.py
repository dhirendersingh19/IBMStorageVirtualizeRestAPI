...
class LssafeguardedscheduleIdPostRequest(BaseModel):
    """
    LssafeguardedscheduleIdPostRequest
    """ # noqa: E501
    schedule: Optional[StrictInt] = None
    filtervalue: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["schedule", "filtervalue"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LssafeguardedscheduleIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LssafeguardedscheduleIdPostRequest from a dict"""
        if obj is None:
            return None
