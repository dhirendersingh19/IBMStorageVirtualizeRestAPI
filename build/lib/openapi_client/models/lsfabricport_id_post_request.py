...
class LsfabricportIdPostRequest(BaseModel):
    """
    LsfabricportIdPostRequest
    """ # noqa: E501
    callhome: Optional[StrictBool] = None
    hostcandidate: Optional[StrictBool] = None
    filtervalue: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["callhome", "hostcandidate", "filtervalue"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LsfabricportIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LsfabricportIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "callhome": obj.get("callhome"),
            "hostcandidate": obj.get("hostcandidate"),
