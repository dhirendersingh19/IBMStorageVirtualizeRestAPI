...
class RefreshfromsnapshotPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["volumegroup", "volumes", "fromsnapshotid", "snapshot", "fromsourcegroup", "fromsourceuid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RefreshfromsnapshotPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RefreshfromsnapshotPostRequest from a dict"""
        if obj is None:
            return None
