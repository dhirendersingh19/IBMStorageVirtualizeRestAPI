...
class AddfcportsetmemberPostRequest(BaseModel):
    """
    AddfcportsetmemberPostRequest
    """ # noqa: E501
    portset: Optional[StrictStr] = None
    fcioportid: Optional[StrictInt] = None
    ignoreportlimit: Optional[StrictBool] = None
    ignoreautozoneincapable: Optional[StrictBool] = None
    all: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["portset", "fcioportid", "ignoreportlimit", "ignoreautozoneincapable", "all"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddfcportsetmemberPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddfcportsetmemberPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "fcioportid": obj.get("fcioportid"),
            "ignoreportlimit": obj.get("ignoreportlimit"),
            "ignoreautozoneincapable": obj.get("ignoreautozoneincapable"),
            "all": obj.get("all")
        })
        return _obj
