...
class ChipIdPostRequest(BaseModel):
    """
    ChipIdPostRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["ip", "prefix", "gw", "vlan"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChipIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChipIdPostRequest from a dict"""
        if obj is None:
            return None
