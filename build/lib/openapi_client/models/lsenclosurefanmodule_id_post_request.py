...
class LsenclosurefanmoduleIdPostRequest(BaseModel):
    """
    LsenclosurefanmoduleIdPostRequest
    """ # noqa: E501
    filtervalue: Optional[StrictStr] = None
    fanmodule: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["filtervalue", "fanmodule"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LsenclosurefanmoduleIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LsenclosurefanmoduleIdPostRequest from a dict"""
        if obj is None:
            return None
