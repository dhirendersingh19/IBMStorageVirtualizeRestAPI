...
class MksnmpserverPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "ip", "community", "error", "warning", "info", "port", "engineid", "securityname", "authprotocol", "authpassphrase", "privprotocol", "privpassphrase", "tls"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MksnmpserverPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MksnmpserverPostRequest from a dict"""
        if obj is None:
            return None
