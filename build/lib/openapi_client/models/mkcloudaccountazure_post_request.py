...
class MkcloudaccountazurePostRequest(BaseModel):
    """
    MkcloudaccountazurePostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    storageaccountkey: Optional[StrictStr] = None
    containerprefix: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["name", "storageaccountkey", "containerprefix", "storageaccountname", "encrypt", "recovery", "upbandwidthmbits", "downbandwidthmbits", "certificate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkcloudaccountazurePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkcloudaccountazurePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "containerprefix": obj.get("containerprefix"),
