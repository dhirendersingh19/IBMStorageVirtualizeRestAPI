...
class RegisterpluginPostRequest(BaseModel):
    """
    RegisterpluginPostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    uniquekey: Optional[StrictStr] = None
    version: Optional[StrictStr] = None
    metadata: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "uniquekey", "version", "metadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RegisterpluginPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RegisterpluginPostRequest from a dict"""
        if obj is None:
            return None
