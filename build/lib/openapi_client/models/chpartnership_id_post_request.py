...
class ChpartnershipIdPostRequest(BaseModel):
    """
    ChpartnershipIdPostRequest
    """ # noqa: E501
    clusterip: Optional[StrictStr] = None
    chapsecret: Optional[StrictStr] = None
    nochapsecret: Optional[StrictBool] = None
    linkbandwidthmbits: Optional[StrictInt] = None
    backgroundcopyrate: Optional[StrictInt] = None
    start: Optional[StrictBool] = None
    stop: Optional[StrictBool] = None
    compressed: Optional[StrictInt] = None
    link1: Optional[StrictStr] = None
    link2: Optional[StrictStr] = None
    nolink1: Optional[StrictBool] = None
    nolink2: Optional[StrictBool] = None
    secured: Optional[StrictInt] = None
    newclusterid: Optional[StrictStr] = None
    pbrinuse: Optional[StrictInt] = None
    type: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["clusterip", "chapsecret", "nochapsecret", "linkbandwidthmbits", "backgroundcopyrate", "start", "stop", "compressed", "link1", "link2", "nolink1", "nolink2", "secured", "newclusterid", "pbrinuse", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChpartnershipIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChpartnershipIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "linkbandwidthmbits": obj.get("linkbandwidthmbits"),
            "backgroundcopyrate": obj.get("backgroundcopyrate"),
            "start": obj.get("start"),
            "stop": obj.get("stop"),
            "compressed": obj.get("compressed"),
            "link1": obj.get("link1"),
            "link2": obj.get("link2"),
            "nolink1": obj.get("nolink1"),
            "nolink2": obj.get("nolink2"),
            "secured": obj.get("secured"),
            "newclusterid": obj.get("newclusterid"),
            "pbrinuse": obj.get("pbrinuse"),
            "type": obj.get("type")
        })
        return _obj
