...
class ChsystemcertPostRequest(BaseModel):
    """
    ChsystemcertPostRequest
    """ # noqa: E501
    export: Optional[StrictBool] = None
    install: Optional[StrictBool] = None
    file: Optional[StrictStr] = None
    mkselfsigned: Optional[StrictBool] = None
    mkrequest: Optional[StrictBool] = None
    mksystemsigned: Optional[StrictBool] = None
    country: Optional[StrictStr] = None
    state: Optional[StrictStr] = None
    locality: Optional[StrictStr] = None
    org: Optional[StrictStr] = None
    orgunit: Optional[StrictStr] = None
    commonname: Optional[StrictStr] = None
    subjectalternativename: Optional[StrictStr] = None
    email: Optional[StrictStr] = None
    keytype: Optional[StrictInt] = None
    validity: Optional[StrictInt] = None
    force: Optional[StrictBool] = None
    cancel: Optional[StrictBool] = None
    autorenew: Optional[StrictBool] = None
    exportrootcacert: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["export", "install", "file", "mkselfsigned", "mkrequest", "mksystemsigned", "country", "state", "locality", "org", "orgunit", "commonname", "subjectalternativename", "email", "keytype", "validity", "force", "cancel", "autorenew", "exportrootcacert"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChsystemcertPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChsystemcertPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "file": obj.get("file"),
            "mkselfsigned": obj.get("mkselfsigned"),
            "mkrequest": obj.get("mkrequest"),
            "mksystemsigned": obj.get("mksystemsigned"),
            "country": obj.get("country"),
            "state": obj.get("state"),
            "locality": obj.get("locality"),
            "org": obj.get("org"),
            "orgunit": obj.get("orgunit"),
            ...
            "exportrootcacert": obj.get("exportrootcacert")
        })
        return _obj
