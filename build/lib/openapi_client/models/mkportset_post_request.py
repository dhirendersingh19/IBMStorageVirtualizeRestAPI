...
class MkportsetPostRequest(BaseModel):
    """
    MkportsetPostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    porttype: Optional[StrictInt] = None
    ...
    autozoneenabled: Optional[StrictInt] = None
    replicationusagehint: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["name", "porttype", "type", "ownershipgroup", "replicationportsetlinkuid", "force", "autozoneenabled", "replicationusagehint"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkportsetPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkportsetPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "force": obj.get("force"),
            "autozoneenabled": obj.get("autozoneenabled"),
