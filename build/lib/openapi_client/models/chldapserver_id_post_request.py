...
class ChldapserverIdPostRequest(BaseModel):
    """
    ...
    basedn: Optional[StrictStr] = None
    nobasedn: Optional[StrictStr] = None
    preferred: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["ip", "name", "port", "sslcert", "nosslcert", "basedn", "nobasedn", "preferred"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChldapserverIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChldapserverIdPostRequest from a dict"""
        if obj is None:
            return None
