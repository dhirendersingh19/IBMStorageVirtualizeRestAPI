...
class SendcloudcallhomePostRequest(BaseModel):
    """
    SendcloudcallhomePostRequest
    """ # noqa: E501
    connectiontest: Optional[StrictBool] = None
    uploadtest: Optional[StrictBool] = None
    inventory: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["connectiontest", "uploadtest", "inventory"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SendcloudcallhomePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SendcloudcallhomePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "connectiontest": obj.get("connectiontest"),
            "uploadtest": obj.get("uploadtest"),
