...
class ExpandarrayIdPostRequest(BaseModel):
    """
    ExpandarrayIdPostRequest
    """ # noqa: E501
    totaldrivecount: Optional[StrictInt] = None
    driveclass: Optional[StrictInt] = None
    totalrebuildareas: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["totaldrivecount", "driveclass", "totalrebuildareas"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExpandarrayIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExpandarrayIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "totaldrivecount": obj.get("totaldrivecount"),
            "driveclass": obj.get("driveclass"),
            "totalrebuildareas": obj.get("totalrebuildareas")
        })
        return _obj
