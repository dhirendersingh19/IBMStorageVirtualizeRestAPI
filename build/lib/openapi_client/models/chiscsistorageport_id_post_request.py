...
class ChiscsistorageportIdPostRequest(BaseModel):
    """
    ChiscsistorageportIdPostRequest
    """ # noqa: E501
    username: Optional[StrictStr] = None
    chapsecret: Optional[StrictStr] = None
    noauth: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["username", "chapsecret", "noauth"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChiscsistorageportIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChiscsistorageportIdPostRequest from a dict"""
        if obj is None:
            return None
