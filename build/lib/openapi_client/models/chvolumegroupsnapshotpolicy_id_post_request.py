...
class ChvolumegroupsnapshotpolicyIdPostRequest(BaseModel):
    """
    ChvolumegroupsnapshotpolicyIdPostRequest
    """ # noqa: E501
    snapshotpolicysuspended: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["snapshotpolicysuspended"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChvolumegroupsnapshotpolicyIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChvolumegroupsnapshotpolicyIdPostRequest from a dict"""
        if obj is None:
            return None
