...
class MkvasaclientcertificatePostRequest(BaseModel):
    """
    MkvasaclientcertificatePostRequest
    """ # noqa: E501
    file: Optional[StrictStr] = None
    partition: Optional[StrictStr] = None
    vcclientuuid: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["file", "partition", "vcclientuuid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkvasaclientcertificatePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkvasaclientcertificatePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "vcclientuuid": obj.get("vcclientuuid")
        })
        return _obj
