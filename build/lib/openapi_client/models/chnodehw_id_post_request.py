...
class ChnodehwIdPostRequest(BaseModel):
    """
    ChnodehwIdPostRequest
    """ # noqa: E501
    force: Optional[StrictBool] = None
    legacy: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["force", "legacy"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChnodehwIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChnodehwIdPostRequest from a dict"""
        if obj is None:
            return None
