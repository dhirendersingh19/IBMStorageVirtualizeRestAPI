...
class RmfcportsetmemberPostRequest(BaseModel):
    """
    RmfcportsetmemberPostRequest
    """ # noqa: E501
    portset: Optional[StrictStr] = None
    fcioportid: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["portset", "fcioportid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RmfcportsetmemberPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RmfcportsetmemberPostRequest from a dict"""
        if obj is None:
            return None
