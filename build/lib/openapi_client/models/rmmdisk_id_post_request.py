...
class RmmdiskIdPostRequest(BaseModel):
    """
    RmmdiskIdPostRequest
    """ # noqa: E501
    mdisk: Optional[StrictStr] = None
    force: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["mdisk", "force"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RmmdiskIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RmmdiskIdPostRequest from a dict"""
        if obj is None:
            return None
