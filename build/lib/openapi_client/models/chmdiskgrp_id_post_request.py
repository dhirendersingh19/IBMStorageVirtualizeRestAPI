...
class ChmdiskgrpIdPostRequest(BaseModel):
    """
    ...
    etfcmoverallocationmax: Optional[StrictStr] = None
    provisioningpolicy: Optional[StrictStr] = None
    noprovisioningpolicy: Optional[StrictBool] = None
    replicationpoollinkuid: Optional[StrictStr] = None
    movepoollink: Optional[StrictBool] = None
    replaceexistinglink: Optional[StrictBool] = None
    resetreplicationpoollinkuid: Optional[StrictBool] = None
    replicationpoollinkedsystemsmask: Optional[StrictInt] = None
    snapshotbuffercopyrate: Optional[StrictInt] = None
    snapshotbuffercleanrate: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["name", "warning", "unit", "easytier", "size", "etfcmoverallocationmax", "provisioningpolicy", "noprovisioningpolicy", "replicationpoollinkuid", "movepoollink", "replaceexistinglink", "resetreplicationpoollinkuid", "replicationpoollinkedsystemsmask", "snapshotbuffercopyrate", "snapshotbuffercleanrate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChmdiskgrpIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChmdiskgrpIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "etfcmoverallocationmax": obj.get("etfcmoverallocationmax"),
            "provisioningpolicy": obj.get("provisioningpolicy"),
            "noprovisioningpolicy": obj.get("noprovisioningpolicy"),
            "replicationpoollinkuid": obj.get("replicationpoollinkuid"),
            "movepoollink": obj.get("movepoollink"),
            "replaceexistinglink": obj.get("replaceexistinglink"),
            "resetreplicationpoollinkuid": obj.get("resetreplicationpoollinkuid"),
            "replicationpoollinkedsystemsmask": obj.get("replicationpoollinkedsystemsmask"),
            "snapshotbuffercopyrate": obj.get("snapshotbuffercopyrate"),
            "snapshotbuffercleanrate": obj.get("snapshotbuffercleanrate")
        })
        return _obj
