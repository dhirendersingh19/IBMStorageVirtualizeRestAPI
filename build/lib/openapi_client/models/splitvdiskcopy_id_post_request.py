...
class SplitvdiskcopyIdPostRequest(BaseModel):
    """
    ...
    activeactive: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["iogrp", "node", "name", "cache", "udid", "force", "copy", "accessiogrp", "activeactive"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SplitvdiskcopyIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SplitvdiskcopyIdPostRequest from a dict"""
        if obj is None:
            return None
