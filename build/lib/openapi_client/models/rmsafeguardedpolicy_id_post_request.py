...
class RmsafeguardedpolicyIdPostRequest(BaseModel):
    """
    RmsafeguardedpolicyIdPostRequest
    """ # noqa: E501
    removefromvolumegroups: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["removefromvolumegroups"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RmsafeguardedpolicyIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RmsafeguardedpolicyIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "removefromvolumegroups": obj.get("removefromvolumegroups")
        })
        return _obj
