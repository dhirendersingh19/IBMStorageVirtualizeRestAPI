...
class LsvdisklbaPostRequest(BaseModel):
    """
    LsvdisklbaPostRequest
    """ # noqa: E501
    mdisk: Optional[StrictStr] = None
    mdisklba: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["mdisk", "mdisklba"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LsvdisklbaPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LsvdisklbaPostRequest from a dict"""
        if obj is None:
            return None
