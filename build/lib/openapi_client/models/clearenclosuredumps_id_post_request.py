...
class ClearenclosuredumpsIdPostRequest(BaseModel):
    """
    ClearenclosuredumpsIdPostRequest
    """ # noqa: E501
    canister: Optional[StrictStr] = None
    canister_id: Optional[StrictStr] = None
    prefix: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["canister", "canister_id", "prefix"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ClearenclosuredumpsIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ClearenclosuredumpsIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "canister_id": obj.get("canister_id"),
