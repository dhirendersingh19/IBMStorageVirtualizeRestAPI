...
class StartfcconsistgrpIdPostRequest(BaseModel):
    """
    StartfcconsistgrpIdPostRequest
    """ # noqa: E501
    prep: Optional[StrictBool] = None
    restore: Optional[StrictBool] = None
    retentiondays: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["prep", "restore", "retentiondays"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StartfcconsistgrpIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StartfcconsistgrpIdPostRequest from a dict"""
        if obj is None:
            return None
