...
class MkquorumappPostRequest(BaseModel):
    """
    MkquorumappPostRequest
    """ # noqa: E501
    ip_6: Optional[StrictBool] = None
    nometadata: Optional[StrictBool] = None
    partnersystem: Optional[StrictStr] = None
    partnerip6: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["ip_6", "nometadata", "partnersystem", "partnerip6"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkquorumappPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkquorumappPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "ip_6": obj.get("ip_6"),
            "nometadata": obj.get("nometadata"),
            "partnersystem": obj.get("partnersystem"),
            "partnerip6": obj.get("partnerip6")
        })
        return _obj
