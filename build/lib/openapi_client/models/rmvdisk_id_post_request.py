...
class RmvdiskIdPostRequest(BaseModel):
    """
    RmvdiskIdPostRequest
    """ # noqa: E501
    force: Optional[StrictBool] = None
    removehostmappings: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["force", "removehostmappings"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RmvdiskIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RmvdiskIdPostRequest from a dict"""
        if obj is None:
            return None
