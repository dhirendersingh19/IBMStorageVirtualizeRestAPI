...
class RmownershipgroupIdPostRequest(BaseModel):
    """
    RmownershipgroupIdPostRequest
    """ # noqa: E501
    keepobjects: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["keepobjects"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RmownershipgroupIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RmownershipgroupIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "keepobjects": obj.get("keepobjects")
        })
        return _obj
