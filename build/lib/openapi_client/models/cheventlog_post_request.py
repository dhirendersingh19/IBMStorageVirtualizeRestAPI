...
class CheventlogPostRequest(BaseModel):
    """
    CheventlogPostRequest
    """ # noqa: E501
    fix: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["fix"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CheventlogPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CheventlogPostRequest from a dict"""
        if obj is None:
            return None
