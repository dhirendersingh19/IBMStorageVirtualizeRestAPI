...
class SvcSnapPostRequest(BaseModel):
    """
    SvcSnapPostRequest
    """ # noqa: E501
    upload: Optional[StrictBool] = None
    pmr: Optional[StrictStr] = None
    x____: Optional[StrictStr] = Field(default=None, alias="x[...]")
    clean: Optional[StrictBool] = None
    stats: Optional[StrictBool] = None
    s: Optional[StrictBool] = None
    ups: Optional[StrictBool] = None
    u: Optional[StrictBool] = None
    dump: Optional[StrictBool] = None
    d: Optional[StrictBool] = None
    dumpall: Optional[StrictBool] = None
    a: Optional[StrictBool] = None
    dumpenc: Optional[StrictBool] = None
    e: Optional[StrictBool] = None
    minidump: Optional[StrictBool] = None
    noimm: Optional[StrictBool] = None
    n: Optional[StrictBool] = None
    fcm: Optional[StrictBool] = None
    f: Optional[StrictBool] = None
    anomalystats: Optional[StrictBool] = None
    t: Optional[StrictBool] = None
    gui1: Optional[StrictBool] = None
    gui2: Optional[StrictBool] = None
    gui3: Optional[StrictBool] = None
    help: Optional[StrictBool] = None
    h: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["upload", "pmr", "x[...]", "clean", "stats", "s", "ups", "u", "dump", "d", "dumpall", "a", "dumpenc", "e", "minidump", "noimm", "n", "fcm", "f", "anomalystats", "t", "gui1", "gui2", "gui3", "help", "h"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SvcSnapPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SvcSnapPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "dump": obj.get("dump"),
            "d": obj.get("d"),
            "dumpall": obj.get("dumpall"),
            "a": obj.get("a"),
            "dumpenc": obj.get("dumpenc"),
            "e": obj.get("e"),
            "minidump": obj.get("minidump"),
            "noimm": obj.get("noimm"),
            "n": obj.get("n"),
            "fcm": obj.get("fcm"),
            "f": obj.get("f"),
            "anomalystats": obj.get("anomalystats"),
            "t": obj.get("t"),
            "gui1": obj.get("gui1"),
            "gui2": obj.get("gui2"),
            "gui3": obj.get("gui3"),
