...
class ChsafeguardedpolicyIdPostRequest(BaseModel):
    """
    ChsafeguardedpolicyIdPostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    chschedule: Optional[StrictInt] = None
    rmschedule: Optional[StrictInt] = None
    addschedule: Optional[StrictBool] = None
    ...
    __properties: ClassVar[List[str]] = ["name", "chschedule", "rmschedule", "addschedule", "backupunit", "backupinterval", "backupstarttime", "retentiondays"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChsafeguardedpolicyIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChsafeguardedpolicyIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "chschedule": obj.get("chschedule"),
            "rmschedule": obj.get("rmschedule"),
            "addschedule": obj.get("addschedule"),
