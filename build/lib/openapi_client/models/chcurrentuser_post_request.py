...
class ChcurrentuserPostRequest(BaseModel):
    """
    ...
    gridsystemsetup: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["password", "nopassword", "keyfile", "nokey", "certuid", "nocertuid", "gridsystemsetup"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChcurrentuserPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChcurrentuserPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "gridsystemsetup": obj.get("gridsystemsetup")
        })
        return _obj
