...
class MkvdiskhostmapIdPostRequest(BaseModel):
    """
    MkvdiskhostmapIdPostRequest
    """ # noqa: E501
    host: Optional[StrictStr] = None
    scsi: Optional[StrictInt] = None
    scsilist: Optional[StrictStr] = None
    force: Optional[StrictBool] = None
    allowmismatchedscsiids: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["host", "scsi", "scsilist", "force", "allowmismatchedscsiids"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkvdiskhostmapIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkvdiskhostmapIdPostRequest from a dict"""
        if obj is None:
            return None
