...
class MkfcpartnershipIdPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["linkbandwidthmbits", "backgroundcopyrate", "portset"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkfcpartnershipIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkfcpartnershipIdPostRequest from a dict"""
        if obj is None:
            return None
