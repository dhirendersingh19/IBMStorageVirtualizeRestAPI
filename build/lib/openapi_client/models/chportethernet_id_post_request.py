...
class ChportethernetIdPostRequest(BaseModel):
    """
    ...
    defaultmtu: Optional[StrictBool] = None
    force: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["iogrp", "host", "storage", "replication", "mtu", "defaultmtu", "force"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChportethernetIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChportethernetIdPostRequest from a dict"""
        if obj is None:
            return None
