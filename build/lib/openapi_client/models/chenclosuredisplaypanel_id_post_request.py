...
class ChenclosuredisplaypanelIdPostRequest(BaseModel):
    """
    ChenclosuredisplaypanelIdPostRequest
    """ # noqa: E501
    clearswap: Optional[StrictStr] = None
    displaypanel: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["clearswap", "displaypanel"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChenclosuredisplaypanelIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChenclosuredisplaypanelIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "displaypanel": obj.get("displaypanel")
        })
        return _obj
