...
class LsportethernetIdPostRequest(BaseModel):
    """
    LsportethernetIdPostRequest
    """ # noqa: E501
    node: Optional[StrictStr] = None
    filtervalue: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["node", "filtervalue"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LsportethernetIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LsportethernetIdPostRequest from a dict"""
        if obj is None:
            return None
