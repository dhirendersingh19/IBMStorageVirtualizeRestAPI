...
class MksnapshotpolicyPostRequest(BaseModel):
    """
    MksnapshotpolicyPostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    backupunit: Optional[StrictInt] = None
    backupinterval: Optional[StrictInt] = None
    backupstarttime: Optional[StrictStr] = None
    retentiondays: Optional[StrictInt] = None
    type: Optional[StrictInt] = None
    backupunit2: Optional[StrictInt] = None
    backupinterval2: Optional[StrictInt] = None
    backupstarttime2: Optional[StrictStr] = None
    retentiondays2: Optional[StrictInt] = None
    type2: Optional[StrictInt] = None
    safeguarded: Optional[StrictBool] = None
    safeguarded2: Optional[StrictBool] = None
    partition: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "backupunit", "backupinterval", "backupstarttime", "retentiondays", "type", "backupunit2", "backupinterval2", "backupstarttime2", "retentiondays2", "type2", "safeguarded", "safeguarded2", "partition"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MksnapshotpolicyPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MksnapshotpolicyPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "backupunit": obj.get("backupunit"),
            "backupinterval": obj.get("backupinterval"),
            "backupstarttime": obj.get("backupstarttime"),
            "retentiondays": obj.get("retentiondays"),
            "type": obj.get("type"),
            "backupunit2": obj.get("backupunit2"),
            "backupinterval2": obj.get("backupinterval2"),
            "backupstarttime2": obj.get("backupstarttime2"),
            "retentiondays2": obj.get("retentiondays2"),
            "type2": obj.get("type2"),
            "safeguarded": obj.get("safeguarded"),
            "safeguarded2": obj.get("safeguarded2"),
