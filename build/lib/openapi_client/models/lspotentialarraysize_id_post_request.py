...
class LspotentialarraysizeIdPostRequest(BaseModel):
    """
    LspotentialarraysizeIdPostRequest
    """ # noqa: E501
    driveclass: Optional[StrictInt] = None
    drivecount: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["driveclass", "drivecount", "level", "stripewidth", "strip", "rebuildareas"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LspotentialarraysizeIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LspotentialarraysizeIdPostRequest from a dict"""
        if obj is None:
            return None
