...
class RmnodeIdPostRequest(BaseModel):
    """
    RmnodeIdPostRequest
    """ # noqa: E501
    force: Optional[StrictBool] = None
    deactivatespare: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["force", "deactivatespare"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RmnodeIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RmnodeIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "force": obj.get("force"),
            "deactivatespare": obj.get("deactivatespare")
        })
        return _obj
