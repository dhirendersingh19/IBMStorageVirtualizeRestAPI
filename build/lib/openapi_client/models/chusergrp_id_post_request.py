...
class ChusergrpIdPostRequest(BaseModel):
    """
    ChusergrpIdPostRequest
    """ # noqa: E501
    role: Optional[StrictStr] = None
    remote: Optional[StrictInt] = None
    ownershipgroup: Optional[StrictStr] = None
    noownershipgroup: Optional[StrictBool] = None
    multifactor: Optional[StrictInt] = None
    passwordkeyrequired: Optional[StrictInt] = None
    disablegui: Optional[StrictInt] = None
    disablecli: Optional[StrictInt] = None
    disablerest: Optional[StrictInt] = None
    linkuid: Optional[StrictStr] = None
    resetlinkuid: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["role", "remote", "ownershipgroup", "noownershipgroup", "multifactor", "passwordkeyrequired", "disablegui", "disablecli", "disablerest", "linkuid", "resetlinkuid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChusergrpIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChusergrpIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "passwordkeyrequired": obj.get("passwordkeyrequired"),
            "disablegui": obj.get("disablegui"),
            "disablecli": obj.get("disablecli"),
            "disablerest": obj.get("disablerest"),
            "linkuid": obj.get("linkuid"),
            "resetlinkuid": obj.get("resetlinkuid")
        })
        return _obj
