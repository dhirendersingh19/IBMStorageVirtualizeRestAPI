...
class RmvolumegroupIdPostRequest(BaseModel):
    """
    RmvolumegroupIdPostRequest
    """ # noqa: E501
    evictvolumes: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["evictvolumes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RmvolumegroupIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RmvolumegroupIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "evictvolumes": obj.get("evictvolumes")
        })
        return _obj
