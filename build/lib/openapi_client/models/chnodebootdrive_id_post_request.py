...
class ChnodebootdriveIdPostRequest(BaseModel):
    """
    ChnodebootdriveIdPostRequest
    """ # noqa: E501
    sync: Optional[StrictStr] = None
    replacecanister: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["sync", "replacecanister"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChnodebootdriveIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChnodebootdriveIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "sync": obj.get("sync"),
            "replacecanister": obj.get("replacecanister")
        })
        return _obj
