...
class LsnodebatteryIdPostRequest(BaseModel):
    """
    LsnodebatteryIdPostRequest
    """ # noqa: E501
    battery: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["battery"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LsnodebatteryIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LsnodebatteryIdPostRequest from a dict"""
        if obj is None:
            return None
