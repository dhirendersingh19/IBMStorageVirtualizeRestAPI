...
class MkusergrpPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "role", "remote", "ownershipgroup", "multifactor", "passwordkeyrequired", "disablegui", "disablecli", "disablerest", "linkuid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkusergrpPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkusergrpPostRequest from a dict"""
        if obj is None:
            return None
