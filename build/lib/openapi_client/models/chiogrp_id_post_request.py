...
class ChiogrpIdPostRequest(BaseModel):
    """
    ...
    fctargetportmode: Optional[StrictInt] = None
    force: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["name", "feature", "size", "kb", "maintenance", "fctargetportmode", "force"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChiogrpIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChiogrpIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "fctargetportmode": obj.get("fctargetportmode"),
            "force": obj.get("force")
        })
        return _obj
