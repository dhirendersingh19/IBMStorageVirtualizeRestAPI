...
class LsnvmefabricPostRequest(BaseModel):
    """
    ...
    remotenqn: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["transport", "node", "port", "host", "remotenqn"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LsnvmefabricPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LsnvmefabricPostRequest from a dict"""
        if obj is None:
            return None
