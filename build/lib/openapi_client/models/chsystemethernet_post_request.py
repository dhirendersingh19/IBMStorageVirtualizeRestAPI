...
class ChsystemethernetPostRequest(BaseModel):
    """
    ChsystemethernetPostRequest
    """ # noqa: E501
    hostattachcos: Optional[StrictInt] = None
    systemcos: Optional[StrictInt] = None
    storagecos: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["hostattachcos", "systemcos", "storagecos"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChsystemethernetPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChsystemethernetPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "hostattachcos": obj.get("hostattachcos"),
            "systemcos": obj.get("systemcos"),
            "storagecos": obj.get("storagecos")
        })
        return _obj
