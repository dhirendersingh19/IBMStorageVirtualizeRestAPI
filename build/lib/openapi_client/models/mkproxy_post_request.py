...
class MkproxyPostRequest(BaseModel):
    """
    MkproxyPostRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["url", "port", "username", "password", "sslcert"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkproxyPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkproxyPostRequest from a dict"""
        if obj is None:
            return None
