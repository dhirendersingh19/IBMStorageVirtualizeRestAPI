...
class ChownershipgroupIdPostRequest(BaseModel):
    """
    ChownershipgroupIdPostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    replicationlinkuid: Optional[StrictStr] = None
    replicationlinkedsystemsmask: Optional[StrictStr] = None
    resetreplicationlinkuid: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["name", "replicationlinkuid", "replicationlinkedsystemsmask", "resetreplicationlinkuid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChownershipgroupIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChownershipgroupIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "replicationlinkuid": obj.get("replicationlinkuid"),
            "replicationlinkedsystemsmask": obj.get("replicationlinkedsystemsmask"),
            "resetreplicationlinkuid": obj.get("resetreplicationlinkuid")
        })
        return _obj
