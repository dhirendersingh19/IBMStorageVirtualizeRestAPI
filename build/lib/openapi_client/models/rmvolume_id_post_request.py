...
class RmvolumeIdPostRequest(BaseModel):
    """
    RmvolumeIdPostRequest
    """ # noqa: E501
    removehostmappings: Optional[StrictBool] = None
    removercrelationships: Optional[StrictBool] = None
    removefcmaps: Optional[StrictBool] = None
    discardimage: Optional[StrictBool] = None
    cancelbackup: Optional[StrictBool] = None
    immediate: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["removehostmappings", "removercrelationships", "removefcmaps", "discardimage", "cancelbackup", "immediate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RmvolumeIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RmvolumeIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "removehostmappings": obj.get("removehostmappings"),
            "removercrelationships": obj.get("removercrelationships"),
            "removefcmaps": obj.get("removefcmaps"),
            "discardimage": obj.get("discardimage"),
            "cancelbackup": obj.get("cancelbackup"),
