...
class MkuserPostRequest(BaseModel):
    """
    MkuserPostRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["name", "password", "remote", "usergrp", "keyfile", "forcepasswordchange", "certuid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkuserPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkuserPostRequest from a dict"""
        if obj is None:
            return None
