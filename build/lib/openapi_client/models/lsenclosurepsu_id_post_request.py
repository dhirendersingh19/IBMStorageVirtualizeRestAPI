...
class LsenclosurepsuIdPostRequest(BaseModel):
    """
    LsenclosurepsuIdPostRequest
    """ # noqa: E501
    filtervalue: Optional[StrictStr] = None
    psu: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["filtervalue", "psu"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LsenclosurepsuIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LsenclosurepsuIdPostRequest from a dict"""
        if obj is None:
            return None
