...
class ChfcmapIdPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "consistgrp", "copyrate", "autodelete", "cleanrate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChfcmapIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChfcmapIdPostRequest from a dict"""
        if obj is None:
            return None
