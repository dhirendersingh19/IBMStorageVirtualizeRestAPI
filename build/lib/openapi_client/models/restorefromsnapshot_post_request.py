...
class RestorefromsnapshotPostRequest(BaseModel):
    """
    RestorefromsnapshotPostRequest
    """ # noqa: E501
    volumegroup: Optional[StrictStr] = None
    volumes: Optional[StrictStr] = None
    snapshotid: Optional[StrictStr] = None
    snapshot: Optional[StrictStr] = None
    parentuid: Optional[StrictInt] = None
    resyncrestoredvolumes: Optional[StrictBool] = None
    restoresource: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["volumegroup", "volumes", "snapshotid", "snapshot", "parentuid", "resyncrestoredvolumes", "restoresource"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RestorefromsnapshotPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RestorefromsnapshotPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "resyncrestoredvolumes": obj.get("resyncrestoredvolumes"),
            "restoresource": obj.get("restoresource")
        })
        return _obj
