...
class ChclusteripPostRequest(BaseModel):
    """
    ChclusteripPostRequest
    """ # noqa: E501
    port: Optional[StrictStr] = None
    clusterip: Optional[StrictStr] = None
    serviceip: Optional[StrictStr] = None
    gw: Optional[StrictStr] = None
    mask: Optional[StrictStr] = None
    clusterip_6: Optional[StrictStr] = None
    serviceip_6: Optional[StrictStr] = None
    gw_6: Optional[StrictStr] = None
    prefix_6: Optional[StrictStr] = None
    noip: Optional[StrictStr] = None
    noip_6: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["port", "clusterip", "serviceip", "gw", "mask", "clusterip_6", "serviceip_6", "gw_6", "prefix_6", "noip", "noip_6"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChclusteripPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChclusteripPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "serviceip": obj.get("serviceip"),
            "gw": obj.get("gw"),
            "mask": obj.get("mask"),
            "clusterip_6": obj.get("clusterip_6"),
            "serviceip_6": obj.get("serviceip_6"),
            "gw_6": obj.get("gw_6"),
            "prefix_6": obj.get("prefix_6"),
            "noip": obj.get("noip"),
            "noip_6": obj.get("noip_6")
        })
        return _obj
