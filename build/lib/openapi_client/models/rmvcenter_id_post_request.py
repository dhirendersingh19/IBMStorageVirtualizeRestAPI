...
class RmvcenterIdPostRequest(BaseModel):
    """
    RmvcenterIdPostRequest
    """ # noqa: E501
    detachpartition: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["detachpartition"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RmvcenterIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RmvcenterIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "detachpartition": obj.get("detachpartition")
        })
        return _obj
