...
class LsenclosuredisplaypanelIdPostRequest(BaseModel):
    """
    LsenclosuredisplaypanelIdPostRequest
    """ # noqa: E501
    filtervalue: Optional[StrictStr] = None
    displaypanel: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["filtervalue", "displaypanel"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LsenclosuredisplaypanelIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LsenclosuredisplaypanelIdPostRequest from a dict"""
        if obj is None:
            return None
