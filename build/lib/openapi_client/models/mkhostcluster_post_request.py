...
class MkhostclusterPostRequest(BaseModel):
    """
    MkhostclusterPostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    seedfromhost: Optional[StrictStr] = None
    ignoreseedvolume: Optional[StrictStr] = None
    partition: Optional[StrictStr] = None
    draftpartition: Optional[StrictStr] = None
    uniformconnectivity: Optional[StrictInt] = None
    uuid: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "seedfromhost", "ignoreseedvolume", "partition", "draftpartition", "uniformconnectivity", "uuid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkhostclusterPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkhostclusterPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "seedfromhost": obj.get("seedfromhost"),
            "ignoreseedvolume": obj.get("ignoreseedvolume"),
