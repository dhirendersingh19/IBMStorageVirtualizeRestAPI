...
class AddsnapshotpolicyscheduleIdPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["backupunit", "backupinterval", "retentiondays", "type", "backupstarttime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddsnapshotpolicyscheduleIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddsnapshotpolicyscheduleIdPostRequest from a dict"""
        if obj is None:
            return None
