...
class RmvdiskaccessIdPostRequest(BaseModel):
    """
    RmvdiskaccessIdPostRequest
    """ # noqa: E501
    iogrp: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["iogrp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RmvdiskaccessIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RmvdiskaccessIdPostRequest from a dict"""
        if obj is None:
            return None
