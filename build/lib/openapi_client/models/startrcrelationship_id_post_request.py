...
class StartrcrelationshipIdPostRequest(BaseModel):
    """
    StartrcrelationshipIdPostRequest
    """ # noqa: E501
    primary: Optional[StrictStr] = None
    force: Optional[StrictStr] = None
    clean: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["primary", "force", "clean"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StartrcrelationshipIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StartrcrelationshipIdPostRequest from a dict"""
        if obj is None:
            return None
