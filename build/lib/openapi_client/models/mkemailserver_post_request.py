...
class MkemailserverPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "ip", "port", "username", "password", "secure"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkemailserverPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkemailserverPostRequest from a dict"""
        if obj is None:
            return None
