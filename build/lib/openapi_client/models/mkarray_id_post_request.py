...
class MkarrayIdPostRequest(BaseModel):
    """
    MkarrayIdPostRequest
    """ # noqa: E501
    level: Optional[StrictStr] = None
    drive: Optional[StrictStr] = None
    strip: Optional[StrictInt] = None
    sparegoal: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    slowwritepriority: Optional[StrictInt] = None
    encrypt: Optional[StrictBool] = None
    rebuildpriority: Optional[StrictInt] = None
    rebuildahead: Optional[StrictInt] = None
    unit: Optional[StrictStr] = None
    reservesize: Optional[StrictInt] = None
    memberblockcount: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["level", "drive", "strip", "sparegoal", "name", "slowwritepriority", "encrypt", "rebuildpriority", "rebuildahead", "unit", "reservesize", "memberblockcount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkarrayIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkarrayIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "drive": obj.get("drive"),
            "strip": obj.get("strip"),
            "sparegoal": obj.get("sparegoal"),
            "name": obj.get("name"),
            "slowwritepriority": obj.get("slowwritepriority"),
            "encrypt": obj.get("encrypt"),
            "rebuildpriority": obj.get("rebuildpriority"),
            "rebuildahead": obj.get("rebuildahead"),
            "unit": obj.get("unit"),
            "reservesize": obj.get("reservesize"),
            "memberblockcount": obj.get("memberblockcount")
        })
        return _obj
