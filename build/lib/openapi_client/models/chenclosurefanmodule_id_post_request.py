...
class ChenclosurefanmoduleIdPostRequest(BaseModel):
    """
    ChenclosurefanmoduleIdPostRequest
    """ # noqa: E501
    clearswap: Optional[StrictStr] = None
    identify: Optional[StrictStr] = None
    fanmodule: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["clearswap", "identify", "fanmodule"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChenclosurefanmoduleIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChenclosurefanmoduleIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "clearswap": obj.get("clearswap"),
            "identify": obj.get("identify"),
            "fanmodule": obj.get("fanmodule")
        })
        return _obj
