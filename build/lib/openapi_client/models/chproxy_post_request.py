...
class ChproxyPostRequest(BaseModel):
    """
    ChproxyPostRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["url", "port", "username", "password", "sslcert", "nousername", "nosslcert"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChproxyPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChproxyPostRequest from a dict"""
        if obj is None:
            return None
