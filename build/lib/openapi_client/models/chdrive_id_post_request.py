...
class ChdriveIdPostRequest(BaseModel):
    """
    ChdriveIdPostRequest
    """ # noqa: E501
    use: Optional[StrictInt] = None
    allowdegraded: Optional[StrictBool] = None
    task: Optional[StrictInt] = None
    type: Optional[StrictInt] = None
    resetonly: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["use", "allowdegraded", "task", "type", "resetonly"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChdriveIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChdriveIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "use": obj.get("use"),
            "allowdegraded": obj.get("allowdegraded"),
            "task": obj.get("task"),
            "type": obj.get("type"),
            "resetonly": obj.get("resetonly")
        })
        return _obj
