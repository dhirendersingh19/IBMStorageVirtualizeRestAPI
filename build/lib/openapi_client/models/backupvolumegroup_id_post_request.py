...
class BackupvolumegroupIdPostRequest(BaseModel):
    """
    BackupvolumegroupIdPostRequest
    """ # noqa: E501
    full: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["full"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BackupvolumegroupIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BackupvolumegroupIdPostRequest from a dict"""
        if obj is None:
            return None
