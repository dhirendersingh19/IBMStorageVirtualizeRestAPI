...
class RegistervcenterIdPostRequest(BaseModel):
    """
    RegistervcenterIdPostRequest
    """ # noqa: E501
    vcuser: Optional[StrictStr] = None
    vcpassword: Optional[StrictStr] = None
    vasapassword: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["vcuser", "vcpassword", "vasapassword"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RegistervcenterIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RegistervcenterIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "vcuser": obj.get("vcuser"),
            "vcpassword": obj.get("vcpassword"),
            "vasapassword": obj.get("vasapassword")
        })
        return _obj
