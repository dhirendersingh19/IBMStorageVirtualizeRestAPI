...
class LsenclosurecanisterIdPostRequest(BaseModel):
    """
    LsenclosurecanisterIdPostRequest
    """ # noqa: E501
    filtervalue: Optional[StrictStr] = None
    canister: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["filtervalue", "canister"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LsenclosurecanisterIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LsenclosurecanisterIdPostRequest from a dict"""
        if obj is None:
            return None
