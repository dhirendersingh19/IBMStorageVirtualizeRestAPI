...
class StopfcconsistgrpIdPostRequest(BaseModel):
    """
    StopfcconsistgrpIdPostRequest
    """ # noqa: E501
    force: Optional[StrictBool] = None
    split: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["force", "split"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StopfcconsistgrpIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StopfcconsistgrpIdPostRequest from a dict"""
        if obj is None:
            return None
