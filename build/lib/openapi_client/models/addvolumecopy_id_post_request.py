...
class AddvolumecopyIdPostRequest(BaseModel):
    """
    ...
    allowmismatchedscsiids: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["pool", "iogrp", "cache", "image", "buffersize", "warning", "noautoexpand", "grainsize", "unit", "thin", "compressed", "deduplicated", "autodelete", "inconsistentownershipgroup", "allowmismatchedscsiids"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddvolumecopyIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddvolumecopyIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "allowmismatchedscsiids": obj.get("allowmismatchedscsiids")
        })
        return _obj
