...
class ChenclosureIdPostRequest(BaseModel):
    """
    ...
    bezelcolor: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["identify", "managed", "id", "bezelcolor"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChenclosureIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChenclosureIdPostRequest from a dict"""
        if obj is None:
            return None
