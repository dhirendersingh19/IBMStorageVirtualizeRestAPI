...
class SwapnodeIdPostRequest(BaseModel):
    """
    SwapnodeIdPostRequest
    """ # noqa: E501
    replace: Optional[StrictBool] = None
    service: Optional[StrictBool] = None
    failover: Optional[StrictBool] = None
    failback: Optional[StrictBool] = None
    force: Optional[StrictStr] = None
    spare: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["replace", "service", "failover", "failback", "force", "spare"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SwapnodeIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SwapnodeIdPostRequest from a dict"""
        if obj is None:
            return None
