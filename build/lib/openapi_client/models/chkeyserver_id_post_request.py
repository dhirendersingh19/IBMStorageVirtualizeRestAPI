...
class ChkeyserverIdPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ip", "port", "sslcert", "nosslcert", "name", "primary"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChkeyserverIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChkeyserverIdPostRequest from a dict"""
        if obj is None:
            return None
