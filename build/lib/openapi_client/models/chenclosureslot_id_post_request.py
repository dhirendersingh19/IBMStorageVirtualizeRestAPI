...
class ChenclosureslotIdPostRequest(BaseModel):
    """
    ...
    slot: Optional[StrictStr] = None
    force: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["identify", "exclude", "port", "slot", "force"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChenclosureslotIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChenclosureslotIdPostRequest from a dict"""
        if obj is None:
            return None
