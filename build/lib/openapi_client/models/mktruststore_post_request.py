...
class MktruststorePostRequest(BaseModel):
    """
    MktruststorePostRequest
    """ # noqa: E501
    file: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    restapi: Optional[StrictBool] = None
    ipsec: Optional[StrictBool] = None
    email: Optional[StrictBool] = None
    snmp: Optional[StrictBool] = None
    syslog: Optional[StrictBool] = None
    grid: Optional[StrictBool] = None
    gridsystemsetup: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["file", "name", "restapi", "ipsec", "email", "snmp", "syslog", "grid", "gridsystemsetup"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MktruststorePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MktruststorePostRequest from a dict"""
        if obj is None:
            return None
