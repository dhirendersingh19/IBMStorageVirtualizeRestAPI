...
class MergepartitionIdPostRequest(BaseModel):
    """
    MergepartitionIdPostRequest
    """ # noqa: E501
    targetpartition: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["targetpartition"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MergepartitionIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MergepartitionIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "targetpartition": obj.get("targetpartition")
        })
        return _obj
