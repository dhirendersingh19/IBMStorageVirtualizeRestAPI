...
class AddmdiskIdPostRequest(BaseModel):
    """
    AddmdiskIdPostRequest
    """ # noqa: E501
    mdisk: Optional[StrictStr] = None
    tier: Optional[StrictInt] = None
    nositecheck: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["mdisk", "tier", "nositecheck"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddmdiskIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddmdiskIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "mdisk": obj.get("mdisk"),
            "tier": obj.get("tier"),
            "nositecheck": obj.get("nositecheck")
        })
        return _obj
