...
class MkpartitioncertstorePostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["systemsigned", "externalsigned", "partition", "country", "state", "locality", "org", "orgunit", "commonname", "subjectalternativename", "email", "keytype", "validity", "autorenew", "file"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkpartitioncertstorePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkpartitioncertstorePostRequest from a dict"""
        if obj is None:
            return None
