...
class ChcloudaccountswiftIdPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "endpoint", "username", "password", "certificate", "nocertificate", "ignorefailures", "mode", "importsystem", "refresh", "resetusagehistory", "upbandwidthmbits", "downbandwidthmbits"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChcloudaccountswiftIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChcloudaccountswiftIdPostRequest from a dict"""
        if obj is None:
            return None
