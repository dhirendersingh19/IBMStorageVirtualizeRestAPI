...
class ChcontrollerIdPostRequest(BaseModel):
    """
    ChcontrollerIdPostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    allowquorum: Optional[StrictStr] = None
    directattachenhanced: Optional[StrictStr] = None
    site: Optional[StrictStr] = None
    nosite: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "allowquorum", "directattachenhanced", "site", "nosite"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChcontrollerIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChcontrollerIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "allowquorum": obj.get("allowquorum"),
            "directattachenhanced": obj.get("directattachenhanced"),
            "site": obj.get("site"),
