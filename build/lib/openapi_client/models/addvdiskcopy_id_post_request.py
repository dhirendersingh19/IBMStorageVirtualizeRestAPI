...
class AddvdiskcopyIdPostRequest(BaseModel):
    """
    ...
    autodelete: Optional[StrictBool] = None
    deduplicated: Optional[StrictBool] = None
    inconsistentownershipgroup: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["mdiskgrp", "vtype", "mdisk", "copies", "createsync", "syncrate", "rsize", "warning", "unit", "autoexpand", "grainsize", "import", "easytier", "tier", "mirrorwritepriority", "compressed", "autodelete", "deduplicated", "inconsistentownershipgroup"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddvdiskcopyIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddvdiskcopyIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "inconsistentownershipgroup": obj.get("inconsistentownershipgroup")
        })
        return _obj
