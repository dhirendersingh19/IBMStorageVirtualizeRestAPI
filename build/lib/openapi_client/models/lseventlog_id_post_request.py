...
class LseventlogIdPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["filtervalue", "alert", "message", "monitoring", "expired", "fixed", "count", "order"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LseventlogIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LseventlogIdPostRequest from a dict"""
        if obj is None:
            return None
