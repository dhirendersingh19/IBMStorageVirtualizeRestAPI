...
class MkownershipgroupPostRequest(BaseModel):
    """
    MkownershipgroupPostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    replicationlinkuid: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "replicationlinkuid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkownershipgroupPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkownershipgroupPostRequest from a dict"""
        if obj is None:
            return None
