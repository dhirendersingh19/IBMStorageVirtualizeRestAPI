...
class MkmdiskgrpPostRequest(BaseModel):
    """
    MkmdiskgrpPostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    mdisk: Optional[StrictStr] = None
    ext: Optional[StrictInt] = None
    warning: Optional[StrictStr] = None
    unit: Optional[StrictStr] = None
    tier: Optional[StrictInt] = None
    easytier: Optional[StrictInt] = None
    size: Optional[StrictInt] = None
    noquota: Optional[StrictBool] = None
    parentmdiskgrp: Optional[StrictStr] = None
    owner: Optional[StrictInt] = None
    encrypt: Optional[StrictInt] = None
    datareduction: Optional[StrictInt] = None
    ...
    __properties: ClassVar[List[str]] = ["name", "mdisk", "ext", "warning", "unit", "tier", "easytier", "size", "noquota", "parentmdiskgrp", "owner", "encrypt", "datareduction", "ownershipgroup", "vdiskprotectionenabled", "safeguarded", "provisioningpolicy", "replicationpoollinkuid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkmdiskgrpPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkmdiskgrpPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "noquota": obj.get("noquota"),
            "parentmdiskgrp": obj.get("parentmdiskgrp"),
            "owner": obj.get("owner"),
