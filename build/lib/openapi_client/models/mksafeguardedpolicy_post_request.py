...
class MksafeguardedpolicyPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "backupunit", "backupinterval", "backupstarttime", "retentiondays", "external"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MksafeguardedpolicyPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MksafeguardedpolicyPostRequest from a dict"""
        if obj is None:
            return None
