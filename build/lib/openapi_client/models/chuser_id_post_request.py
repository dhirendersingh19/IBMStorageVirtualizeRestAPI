...
class ChuserIdPostRequest(BaseModel):
    """
    ChuserIdPostRequest
    """ # noqa: E501
    usergrp: Optional[StrictStr] = None
    password: Optional[StrictStr] = None
    nopassword: Optional[StrictStr] = None
    remote: Optional[StrictInt] = None
    keyfile: Optional[StrictStr] = None
    nokey: Optional[StrictStr] = None
    lock: Optional[StrictStr] = None
    unlock: Optional[StrictStr] = None
    forcepasswordchange: Optional[StrictStr] = None
    certuid: Optional[StrictStr] = None
    nocertuid: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["usergrp", "password", "nopassword", "remote", "keyfile", "nokey", "lock", "unlock", "forcepasswordchange", "certuid", "nocertuid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChuserIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChuserIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "usergrp": obj.get("usergrp"),
            "password": obj.get("password"),
            "nopassword": obj.get("nopassword"),
            "remote": obj.get("remote"),
            "keyfile": obj.get("keyfile"),
            "nokey": obj.get("nokey"),
            "lock": obj.get("lock"),
            "unlock": obj.get("unlock"),
            "forcepasswordchange": obj.get("forcepasswordchange"),
            "certuid": obj.get("certuid"),
            "nocertuid": obj.get("nocertuid")
        })
        return _obj
