...
class LsnodebootdriveIdPostRequest(BaseModel):
    """
    LsnodebootdriveIdPostRequest
    """ # noqa: E501
    slot: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["slot"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LsnodebootdriveIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LsnodebootdriveIdPostRequest from a dict"""
        if obj is None:
            return None
