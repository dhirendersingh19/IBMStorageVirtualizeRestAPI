...
class ChauthmultifactorverifyPostRequest(BaseModel):
    """
    ChauthmultifactorverifyPostRequest
    """ # noqa: E501
    enable: Optional[StrictBool] = None
    failmode: Optional[StrictInt] = None
    hostname: Optional[StrictStr] = None
    port: Optional[StrictInt] = None
    adminenrolled: Optional[StrictInt] = None
    maxprompts: Optional[StrictInt] = None
    openidclientid: Optional[StrictStr] = None
    openidclientsecret: Optional[StrictStr] = None
    cliclientid: Optional[StrictStr] = None
    cliclientsecret: Optional[StrictStr] = None
    disable: Optional[StrictBool] = None
    force: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["enable", "failmode", "hostname", "port", "adminenrolled", "maxprompts", "openidclientid", "openidclientsecret", "cliclientid", "cliclientsecret", "disable", "force"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChauthmultifactorverifyPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChauthmultifactorverifyPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "failmode": obj.get("failmode"),
            "hostname": obj.get("hostname"),
            "port": obj.get("port"),
            "adminenrolled": obj.get("adminenrolled"),
            "maxprompts": obj.get("maxprompts"),
            "openidclientid": obj.get("openidclientid"),
            "openidclientsecret": obj.get("openidclientsecret"),
            "cliclientid": obj.get("cliclientid"),
            "cliclientsecret": obj.get("cliclientsecret"),
