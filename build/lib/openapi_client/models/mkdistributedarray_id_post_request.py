...
class MkdistributedarrayIdPostRequest(BaseModel):
    """
    MkdistributedarrayIdPostRequest
    """ # noqa: E501
    level: Optional[StrictStr] = None
    strip: Optional[StrictInt] = None
    driveclass: Optional[StrictInt] = None
    drivecount: Optional[StrictInt] = None
    stripewidth: Optional[StrictInt] = None
    allowsuperior: Optional[StrictBool] = None
    rebuildareas: Optional[StrictInt] = None
    rebuildareasgoal: Optional[StrictInt] = None
    encrypt: Optional[StrictBool] = None
    name: Optional[StrictStr] = None
    slowwritepriority: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["level", "strip", "driveclass", "drivecount", "stripewidth", "allowsuperior", "rebuildareas", "rebuildareasgoal", "encrypt", "name", "slowwritepriority"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkdistributedarrayIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkdistributedarrayIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "level": obj.get("level"),
            "strip": obj.get("strip"),
            "driveclass": obj.get("driveclass"),
            "drivecount": obj.get("drivecount"),
            "stripewidth": obj.get("stripewidth"),
            "allowsuperior": obj.get("allowsuperior"),
            "rebuildareas": obj.get("rebuildareas"),
            "rebuildareasgoal": obj.get("rebuildareasgoal"),
            "encrypt": obj.get("encrypt"),
            "name": obj.get("name"),
            "slowwritepriority": obj.get("slowwritepriority")
        })
        return _obj
