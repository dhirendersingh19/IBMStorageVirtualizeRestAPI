...
class ChsnapshotPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["volumegroup", "parentuid", "snapshot", "snapshotid", "name", "ownershipgroup", "noownershipgroup"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChsnapshotPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChsnapshotPostRequest from a dict"""
        if obj is None:
            return None
