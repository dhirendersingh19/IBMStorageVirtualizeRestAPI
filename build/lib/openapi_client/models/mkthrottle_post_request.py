...
class MkthrottlePostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "bandwidth", "iops", "name", "vdisk", "host", "hostcluster", "mdiskgrp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkthrottlePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkthrottlePostRequest from a dict"""
        if obj is None:
            return None
