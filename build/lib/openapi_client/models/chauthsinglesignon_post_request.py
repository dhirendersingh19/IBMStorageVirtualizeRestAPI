...
class ChauthsinglesignonPostRequest(BaseModel):
    """
    ChauthsinglesignonPostRequest
    """ # noqa: E501
    enable: Optional[StrictBool] = None
    oidcconfigurationendpoint: Optional[StrictStr] = None
    proxy: Optional[StrictBool] = None
    clientid: Optional[StrictStr] = None
    clientsecret: Optional[StrictStr] = None
    groupclaim: Optional[StrictStr] = None
    userclaim: Optional[StrictStr] = None
    disable: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["enable", "oidcconfigurationendpoint", "proxy", "clientid", "clientsecret", "groupclaim", "userclaim", "disable"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChauthsinglesignonPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChauthsinglesignonPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "oidcconfigurationendpoint": obj.get("oidcconfigurationendpoint"),
            "proxy": obj.get("proxy"),
            "clientid": obj.get("clientid"),
            "clientsecret": obj.get("clientsecret"),
            "groupclaim": obj.get("groupclaim"),
