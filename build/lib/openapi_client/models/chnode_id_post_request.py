...
class ChnodeIdPostRequest(BaseModel):
    """
    ChnodeIdPostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    iscsialias: Optional[StrictStr] = None
    failover: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "iscsialias", "failover"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChnodeIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChnodeIdPostRequest from a dict"""
        if obj is None:
            return None
