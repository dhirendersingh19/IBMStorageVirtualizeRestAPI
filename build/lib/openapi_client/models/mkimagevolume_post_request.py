...
class MkimagevolumePostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "pool", "size", "iogrp", "cache", "udid", "warning", "unit", "mdisk", "thin", "compressed", "volumegroup"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkimagevolumePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkimagevolumePostRequest from a dict"""
        if obj is None:
            return None
