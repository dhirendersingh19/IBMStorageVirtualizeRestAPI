...
class RepairsevdiskcopyIdPostRequest(BaseModel):
    """
    RepairsevdiskcopyIdPostRequest
    """ # noqa: E501
    copy: Optional[StrictInt] = None
    validate: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["copy", "validate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RepairsevdiskcopyIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RepairsevdiskcopyIdPostRequest from a dict"""
        if obj is None:
            return None
