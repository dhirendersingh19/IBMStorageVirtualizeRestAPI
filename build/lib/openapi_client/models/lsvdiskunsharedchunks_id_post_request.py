...
class LsvdiskunsharedchunksIdPostRequest(BaseModel):
    """
    LsvdiskunsharedchunksIdPostRequest
    """ # noqa: E501
    base: Optional[StrictStr] = None
    startlba: Optional[StrictStr] = None
    lbacount: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["base", "startlba", "lbacount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LsvdiskunsharedchunksIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LsvdiskunsharedchunksIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "base": obj.get("base"),
            "startlba": obj.get("startlba"),
            "lbacount": obj.get("lbacount")
        })
        return _obj
