...
class LsenclosurestatsIdPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["filtervalue", "history", "hours", "minutes", "days"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LsenclosurestatsIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LsenclosurestatsIdPostRequest from a dict"""
        if obj is None:
            return None
