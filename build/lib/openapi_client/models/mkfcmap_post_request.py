...
class MkfcmapPostRequest(BaseModel):
    """
    MkfcmapPostRequest
    """ # noqa: E501
    ...
    copyrate: Optional[StrictInt] = None
    autodelete: Optional[StrictBool] = None
    grainsize: Optional[StrictInt] = None
    incremental: Optional[StrictBool] = None
    cleanrate: Optional[StrictInt] = None
    iogrp: Optional[StrictStr] = None
    keeptarget: Optional[StrictBool] = None
    svcconfig: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["source", "target", "name", "consistgrp", "copyrate", "autodelete", "grainsize", "incremental", "cleanrate", "iogrp", "keeptarget", "svcconfig"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkfcmapPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkfcmapPostRequest from a dict"""
        if obj is None:
            return None
