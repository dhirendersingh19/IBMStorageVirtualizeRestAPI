...
class MkclusterPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "serviceip", "serviceip_6"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkclusterPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkclusterPostRequest from a dict"""
        if obj is None:
            return None
