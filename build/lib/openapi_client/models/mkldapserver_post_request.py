...
class MkldapserverPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ip", "name", "port", "sslcert", "basedn", "preferred"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkldapserverPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkldapserverPostRequest from a dict"""
        if obj is None:
            return None
