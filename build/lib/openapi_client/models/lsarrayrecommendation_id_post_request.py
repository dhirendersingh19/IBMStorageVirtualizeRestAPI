...
class LsarrayrecommendationIdPostRequest(BaseModel):
    """
    LsarrayrecommendationIdPostRequest
    """ # noqa: E501
    filtervalue: Optional[StrictStr] = None
    driveclass: Optional[StrictStr] = None
    drivecount: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["filtervalue", "driveclass", "drivecount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LsarrayrecommendationIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LsarrayrecommendationIdPostRequest from a dict"""
        if obj is None:
            return None
