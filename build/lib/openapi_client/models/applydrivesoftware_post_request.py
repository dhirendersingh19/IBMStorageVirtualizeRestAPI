...
class ApplydrivesoftwarePostRequest(BaseModel):
    """
    ApplydrivesoftwarePostRequest
    """ # noqa: E501
    file: Optional[StrictStr] = None
    all: Optional[StrictBool] = None
    drive: Optional[StrictInt] = None
    type: Optional[StrictStr] = None
    force: Optional[StrictStr] = None
    allowdowngrade: Optional[StrictStr] = None
    allowreinstall: Optional[StrictStr] = None
    cancel: Optional[StrictStr] = None
    local: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["file", "all", "drive", "type", "force", "allowdowngrade", "allowreinstall", "cancel", "local"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApplydrivesoftwarePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApplydrivesoftwarePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "force": obj.get("force"),
            "allowdowngrade": obj.get("allowdowngrade"),
            "allowreinstall": obj.get("allowreinstall"),
