...
class RmvolumebackupgenerationPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["volume", "uid", "generation", "all"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RmvolumebackupgenerationPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RmvolumebackupgenerationPostRequest from a dict"""
        if obj is None:
            return None
