...
class CharrayIdPostRequest(BaseModel):
    """
    ...
    scrubrate: Optional[StrictInt] = None
    rebuildareasgoal: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["name", "slowwritepriority", "unit", "scrubrate", "rebuildareasgoal"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CharrayIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CharrayIdPostRequest from a dict"""
        if obj is None:
            return None
