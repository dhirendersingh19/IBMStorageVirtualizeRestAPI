...
class ChhostIdPostRequest(BaseModel):
    """
    ChhostIdPostRequest
    """ # noqa: E501
    ...
    hostsecret: Optional[StrictStr] = None
    nochapsecret: Optional[StrictBool] = None
    nohostsecret: Optional[StrictBool] = None
    storagesecret: Optional[StrictStr] = None
    nostoragesecret: Optional[StrictBool] = None
    site: Optional[StrictStr] = None
    nosite: Optional[StrictBool] = None
    iscsiusername: Optional[StrictStr] = None
    hostusername: Optional[StrictStr] = None
    storageusername: Optional[StrictStr] = None
    statuspolicy: Optional[StrictInt] = None
    statussite: Optional[StrictInt] = None
    ownershipgroup: Optional[StrictStr] = None
    noownershipgroup: Optional[StrictBool] = None
    portset: Optional[StrictStr] = None
    autostoragediscovery: Optional[StrictStr] = None
    ...
    nolocation: Optional[StrictBool] = None
    suppressofflinealert: Optional[StrictStr] = None
    forceautozone: Optional[StrictBool] = None
    force: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["name", "type", "chapsecret", "hostsecret", "nochapsecret", "nohostsecret", "storagesecret", "nostoragesecret", "site", "nosite", "iscsiusername", "hostusername", "storageusername", "statuspolicy", "statussite", "ownershipgroup", "noownershipgroup", "portset", "autostoragediscovery", "partition", "draftpartition", "nopartition", "nodraftpartition", "location", "nolocation", "suppressofflinealert", "forceautozone", "force"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChhostIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChhostIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "hostsecret": obj.get("hostsecret"),
            "nochapsecret": obj.get("nochapsecret"),
            "nohostsecret": obj.get("nohostsecret"),
            "storagesecret": obj.get("storagesecret"),
            "nostoragesecret": obj.get("nostoragesecret"),
            "site": obj.get("site"),
            "nosite": obj.get("nosite"),
            "iscsiusername": obj.get("iscsiusername"),
            "hostusername": obj.get("hostusername"),
            "storageusername": obj.get("storageusername"),
            "statuspolicy": obj.get("statuspolicy"),
            "statussite": obj.get("statussite"),
            "ownershipgroup": obj.get("ownershipgroup"),
            "noownershipgroup": obj.get("noownershipgroup"),
            "portset": obj.get("portset"),
            "autostoragediscovery": obj.get("autostoragediscovery"),
            "partition": obj.get("partition"),
            "draftpartition": obj.get("draftpartition"),
            "nopartition": obj.get("nopartition"),
            "nodraftpartition": obj.get("nodraftpartition"),
            "location": obj.get("location"),
            "nolocation": obj.get("nolocation"),
            "suppressofflinealert": obj.get("suppressofflinealert"),
            "forceautozone": obj.get("forceautozone"),
            "force": obj.get("force")
        })
        return _obj
