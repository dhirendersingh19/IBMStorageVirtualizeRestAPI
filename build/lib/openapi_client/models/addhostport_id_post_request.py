...
class AddhostportIdPostRequest(BaseModel):
    """
    ...
    ibgid: Optional[StrictStr] = None
    forceautozone: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["fcwwpn", "saswwpn", "force", "iscsiname", "nqn", "ibgid", "forceautozone"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddhostportIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddhostportIdPostRequest from a dict"""
        if obj is None:
            return None
