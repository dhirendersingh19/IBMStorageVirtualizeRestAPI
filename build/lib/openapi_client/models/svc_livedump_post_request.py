...
class SvcLivedumpPostRequest(BaseModel):
    """
    SvcLivedumpPostRequest
    """ # noqa: E501
    nodes: Optional[StrictStr] = None
    triggerenclosuredumps: Optional[StrictBool] = None
    triggersesdumps: Optional[StrictBool] = None
    triggerguidump: Optional[StrictBool] = None
    force: Optional[StrictBool] = None
    ignoredependentvdisks: Optional[StrictBool] = None
    yes: Optional[StrictBool] = None
    quiet: Optional[StrictBool] = None
    delay: Optional[StrictStr] = None
    help: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["nodes", "triggerenclosuredumps", "triggersesdumps", "triggerguidump", "force", "ignoredependentvdisks", "yes", "quiet", "delay", "help"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SvcLivedumpPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SvcLivedumpPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "nodes": obj.get("nodes"),
            "triggerenclosuredumps": obj.get("triggerenclosuredumps"),
            "triggersesdumps": obj.get("triggersesdumps"),
            "triggerguidump": obj.get("triggerguidump"),
            "force": obj.get("force"),
            "ignoredependentvdisks": obj.get("ignoredependentvdisks"),
            "yes": obj.get("yes"),
            "quiet": obj.get("quiet"),
            "delay": obj.get("delay"),
            "help": obj.get("help")
