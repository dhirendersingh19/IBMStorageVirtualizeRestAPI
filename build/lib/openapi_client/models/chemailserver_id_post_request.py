...
class ChemailserverIdPostRequest(BaseModel):
    """
    ...
    nocredentials: Optional[StrictStr] = None
    secure: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "ip", "port", "username", "password", "nocredentials", "secure"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChemailserverIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChemailserverIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "nocredentials": obj.get("nocredentials"),
