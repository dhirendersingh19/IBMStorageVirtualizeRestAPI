...
class CfgportipIdPostRequest(BaseModel):
    """
    CfgportipIdPostRequest
    """ # noqa: E501
    node: Optional[StrictStr] = None
    ip: Optional[StrictStr] = None
    ip_6: Optional[StrictStr] = None
    mask: Optional[StrictStr] = None
    prefix_6: Optional[StrictInt] = None
    failover: Optional[StrictStr] = None
    gw: Optional[StrictStr] = None
    gw_6: Optional[StrictStr] = None
    host: Optional[StrictBool] = None
    remotecopy: Optional[StrictStr] = None
    storage: Optional[StrictBool] = None
    host_6: Optional[StrictBool] = None
    remotecopy_6: Optional[StrictStr] = None
    storage_6: Optional[StrictStr] = None
    iogrp: Optional[StrictStr] = None
    mtu: Optional[StrictInt] = None
    defaultmtu: Optional[StrictStr] = None
    vlan: Optional[StrictStr] = None
    vlan_6: Optional[StrictInt] = None
    novlan: Optional[StrictStr] = None
    novlan_6: Optional[StrictStr] = None
    force: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["node", "ip", "ip_6", "mask", "prefix_6", "failover", "gw", "gw_6", "host", "remotecopy", "storage", "host_6", "remotecopy_6", "storage_6", "iogrp", "mtu", "defaultmtu", "vlan", "vlan_6", "novlan", "novlan_6", "force"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CfgportipIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CfgportipIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "ip_6": obj.get("ip_6"),
            "mask": obj.get("mask"),
            "prefix_6": obj.get("prefix_6"),
            "failover": obj.get("failover"),
            "gw": obj.get("gw"),
            "gw_6": obj.get("gw_6"),
            "host": obj.get("host"),
            "remotecopy": obj.get("remotecopy"),
            "storage": obj.get("storage"),
            "host_6": obj.get("host_6"),
            "remotecopy_6": obj.get("remotecopy_6"),
            "storage_6": obj.get("storage_6"),
            "iogrp": obj.get("iogrp"),
            "mtu": obj.get("mtu"),
            "defaultmtu": obj.get("defaultmtu"),
            "vlan": obj.get("vlan"),
            "vlan_6": obj.get("vlan_6"),
            "novlan": obj.get("novlan"),
            "novlan_6": obj.get("novlan_6"),
            "force": obj.get("force")
        })
        return _obj
