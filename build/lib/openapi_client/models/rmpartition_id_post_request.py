...
class RmpartitionIdPostRequest(BaseModel):
    """
    RmpartitionIdPostRequest
    """ # noqa: E501
    deletepreferredmanagementobjects: Optional[StrictBool] = None
    deletenonpreferredmanagementobjects: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["deletepreferredmanagementobjects", "deletenonpreferredmanagementobjects"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RmpartitionIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RmpartitionIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "deletepreferredmanagementobjects": obj.get("deletepreferredmanagementobjects"),
            "deletenonpreferredmanagementobjects": obj.get("deletenonpreferredmanagementobjects")
        })
        return _obj
