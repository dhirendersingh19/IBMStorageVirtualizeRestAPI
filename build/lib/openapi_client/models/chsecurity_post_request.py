...
class ChsecurityPostRequest(BaseModel):
    """
    ChsecurityPostRequest
    """ # noqa: E501
    sslprotocol: Optional[StrictStr] = None
    sshprotocol: Optional[StrictStr] = None
    clitimeout: Optional[StrictStr] = None
    guitimeout: Optional[StrictStr] = None
    restapitimeout: Optional[StrictStr] = None
    minpasswordlength: Optional[StrictStr] = None
    checkpasswordhistory: Optional[StrictStr] = None
    maxpasswordhistory: Optional[StrictStr] = None
    minpasswordage: Optional[StrictStr] = None
    passwordexpiry: Optional[StrictStr] = None
    maxfailedlogins: Optional[StrictStr] = None
    lockoutperiod: Optional[StrictStr] = None
    superuserlocking: Optional[StrictStr] = None
    expirywarning: Optional[StrictStr] = None
    passwordspecialchars: Optional[StrictStr] = None
    passworduppercase: Optional[StrictStr] = None
    passwordlowercase: Optional[StrictStr] = None
    passworddigits: Optional[StrictStr] = None
    resetpolicy: Optional[StrictStr] = None
    superusermultifactor: Optional[StrictStr] = None
    sshgracetime: Optional[StrictStr] = None
    sshmaxtries: Optional[StrictStr] = None
    superuserpasswordkeyrequired: Optional[StrictStr] = None
    disablesuperusergui: Optional[StrictStr] = None
    disablesuperuserrest: Optional[StrictStr] = None
    twopersonintegrity: Optional[StrictStr] = None
    resetsslprotocol: Optional[StrictStr] = None
    resetsshprotocol: Optional[StrictStr] = None
    patchautoupdate: Optional[StrictStr] = None
    sshport: Optional[StrictStr] = None
    iscsihostauthmode: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["sslprotocol", "sshprotocol", "clitimeout", "guitimeout", "restapitimeout", "minpasswordlength", "checkpasswordhistory", "maxpasswordhistory", "minpasswordage", "passwordexpiry", "maxfailedlogins", "lockoutperiod", "superuserlocking", "expirywarning", "passwordspecialchars", "passworduppercase", "passwordlowercase", "passworddigits", "resetpolicy", "superusermultifactor", "sshgracetime", "sshmaxtries", "superuserpasswordkeyrequired", "disablesuperusergui", "disablesuperuserrest", "twopersonintegrity", "resetsslprotocol", "resetsshprotocol", "patchautoupdate", "sshport", "iscsihostauthmode"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChsecurityPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChsecurityPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "sslprotocol": obj.get("sslprotocol"),
            "sshprotocol": obj.get("sshprotocol"),
            "clitimeout": obj.get("clitimeout"),
            "guitimeout": obj.get("guitimeout"),
            "restapitimeout": obj.get("restapitimeout"),
            "minpasswordlength": obj.get("minpasswordlength"),
            "checkpasswordhistory": obj.get("checkpasswordhistory"),
            "maxpasswordhistory": obj.get("maxpasswordhistory"),
            "minpasswordage": obj.get("minpasswordage"),
            "passwordexpiry": obj.get("passwordexpiry"),
            "maxfailedlogins": obj.get("maxfailedlogins"),
            "lockoutperiod": obj.get("lockoutperiod"),
            "superuserlocking": obj.get("superuserlocking"),
            "expirywarning": obj.get("expirywarning"),
            "passwordspecialchars": obj.get("passwordspecialchars"),
            "passworduppercase": obj.get("passworduppercase"),
            "passwordlowercase": obj.get("passwordlowercase"),
            "passworddigits": obj.get("passworddigits"),
            "resetpolicy": obj.get("resetpolicy"),
            "superusermultifactor": obj.get("superusermultifactor"),
            "sshgracetime": obj.get("sshgracetime"),
            "sshmaxtries": obj.get("sshmaxtries"),
            "superuserpasswordkeyrequired": obj.get("superuserpasswordkeyrequired"),
            "disablesuperusergui": obj.get("disablesuperusergui"),
            "disablesuperuserrest": obj.get("disablesuperuserrest"),
            "twopersonintegrity": obj.get("twopersonintegrity"),
            "resetsslprotocol": obj.get("resetsslprotocol"),
            "resetsshprotocol": obj.get("resetsshprotocol"),
            "patchautoupdate": obj.get("patchautoupdate"),
            "sshport": obj.get("sshport"),
            "iscsihostauthmode": obj.get("iscsihostauthmode")
        })
        return _obj
