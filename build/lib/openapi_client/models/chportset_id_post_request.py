...
class ChportsetIdPostRequest(BaseModel):
    """
    ...
    replicationportsetlinkuid: Optional[StrictStr] = None
    resetreplicationportsetlinkuid: Optional[StrictBool] = None
    moveportsetlink: Optional[StrictBool] = None
    replicationportsetlinkedsystemsmask: Optional[StrictInt] = None
    replicationusagehint: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["name", "ownershipgroup", "noownershipgroup", "replicationportsetlinkuid", "resetreplicationportsetlinkuid", "moveportsetlink", "replicationportsetlinkedsystemsmask", "replicationusagehint"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChportsetIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChportsetIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "replicationportsetlinkuid": obj.get("replicationportsetlinkuid"),
            "resetreplicationportsetlinkuid": obj.get("resetreplicationportsetlinkuid"),
            "moveportsetlink": obj.get("moveportsetlink"),
            "replicationportsetlinkedsystemsmask": obj.get("replicationportsetlinkedsystemsmask"),
            "replicationusagehint": obj.get("replicationusagehint")
        })
        return _obj
