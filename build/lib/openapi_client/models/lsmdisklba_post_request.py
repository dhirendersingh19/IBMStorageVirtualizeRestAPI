...
class LsmdisklbaPostRequest(BaseModel):
    """
    LsmdisklbaPostRequest
    """ # noqa: E501
    vdisk: Optional[StrictStr] = None
    lba: Optional[StrictStr] = None
    copy: Optional[StrictInt] = None
    vdisklba: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["vdisk", "lba", "copy", "vdisklba"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LsmdisklbaPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LsmdisklbaPostRequest from a dict"""
        if obj is None:
            return None
