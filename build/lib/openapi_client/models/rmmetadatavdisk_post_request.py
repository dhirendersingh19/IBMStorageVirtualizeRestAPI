...
class RmmetadatavdiskPostRequest(BaseModel):
    """
    RmmetadatavdiskPostRequest
    """ # noqa: E501
    vdisk: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["vdisk"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RmmetadatavdiskPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RmmetadatavdiskPostRequest from a dict"""
        if obj is None:
            return None
