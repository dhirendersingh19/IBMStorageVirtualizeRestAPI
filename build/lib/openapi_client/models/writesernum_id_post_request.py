...
class WritesernumIdPostRequest(BaseModel):
    """
    WritesernumIdPostRequest
    """ # noqa: E501
    sernum: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["sernum"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WritesernumIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WritesernumIdPostRequest from a dict"""
        if obj is None:
            return None
