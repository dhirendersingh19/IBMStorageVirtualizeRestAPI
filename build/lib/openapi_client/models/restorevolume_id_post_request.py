...
class RestorevolumeIdPostRequest(BaseModel):
    """
    RestorevolumeIdPostRequest
    """ # noqa: E501
    fromuid: Optional[StrictStr] = None
    generation: Optional[StrictInt] = None
    restoreuid: Optional[StrictBool] = None
    deletelatergenerations: Optional[StrictBool] = None
    cancel: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["fromuid", "generation", "restoreuid", "deletelatergenerations", "cancel"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RestorevolumeIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RestorevolumeIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "restoreuid": obj.get("restoreuid"),
            "deletelatergenerations": obj.get("deletelatergenerations"),
