...
class ShrinkvdisksizeIdPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["size", "unit", "rsize", "copy"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ShrinkvdisksizeIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ShrinkvdisksizeIdPostRequest from a dict"""
        if obj is None:
            return None
