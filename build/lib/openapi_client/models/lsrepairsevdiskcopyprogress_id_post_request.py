...
class LsrepairsevdiskcopyprogressIdPostRequest(BaseModel):
    """
    LsrepairsevdiskcopyprogressIdPostRequest
    """ # noqa: E501
    copy: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["copy"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LsrepairsevdiskcopyprogressIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LsrepairsevdiskcopyprogressIdPostRequest from a dict"""
        if obj is None:
            return None
