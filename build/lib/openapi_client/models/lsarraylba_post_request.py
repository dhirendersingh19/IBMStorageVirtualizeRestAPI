...
class LsarraylbaPostRequest(BaseModel):
    """
    LsarraylbaPostRequest
    """ # noqa: E501
    drive: Optional[StrictStr] = None
    drivelba: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["drive", "drivelba"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LsarraylbaPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LsarraylbaPostRequest from a dict"""
        if obj is None:
            return None
