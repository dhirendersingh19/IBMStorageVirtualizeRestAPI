...
class ChanomalydetectionPostRequest(BaseModel):
    """
    ChanomalydetectionPostRequest
    """ # noqa: E501
    anomalysnapshot: Optional[StrictInt] = None
    anomalysnapshotretentiondays: Optional[StrictInt] = None
    latestsnapshotextensiondays: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["anomalysnapshot", "anomalysnapshotretentiondays", "latestsnapshotextensiondays"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChanomalydetectionPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChanomalydetectionPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "anomalysnapshot": obj.get("anomalysnapshot"),
            "anomalysnapshotretentiondays": obj.get("anomalysnapshotretentiondays"),
            "latestsnapshotextensiondays": obj.get("latestsnapshotextensiondays")
        })
        return _obj
