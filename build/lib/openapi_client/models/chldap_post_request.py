...
class ChldapPostRequest(BaseModel):
    """
    ChldapPostRequest
    """ # noqa: E501
    ...
    encpassword: Optional[StrictStr] = None
    security: Optional[StrictStr] = None
    userattribute: Optional[StrictStr] = None
    groupattribute: Optional[StrictStr] = None
    auditlogattribute: Optional[StrictStr] = None
    authcacheminutes: Optional[StrictStr] = None
    nestedgroupsearch: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["type", "username", "password", "encpassword", "security", "userattribute", "groupattribute", "auditlogattribute", "authcacheminutes", "nestedgroupsearch"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChldapPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChldapPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "encpassword": obj.get("encpassword"),
            "security": obj.get("security"),
            "userattribute": obj.get("userattribute"),
            "groupattribute": obj.get("groupattribute"),
            "auditlogattribute": obj.get("auditlogattribute"),
            "authcacheminutes": obj.get("authcacheminutes"),
            "nestedgroupsearch": obj.get("nestedgroupsearch")
        })
        return _obj
