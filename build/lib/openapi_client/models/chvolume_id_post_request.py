...
class ChvolumeIdPostRequest(BaseModel):
    """
    ...
    undelete: Optional[StrictBool] = None
    size: Optional[StrictInt] = None
    unit: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "volumegroup", "novolumegroup", "displayname", "undelete", "size", "unit"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChvolumeIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChvolumeIdPostRequest from a dict"""
        if obj is None:
            return None
