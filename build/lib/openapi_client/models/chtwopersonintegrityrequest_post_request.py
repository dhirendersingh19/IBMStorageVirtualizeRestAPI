...
class ChtwopersonintegrityrequestPostRequest(BaseModel):
    """
    ChtwopersonintegrityrequestPostRequest
    """ # noqa: E501
    username: Optional[StrictStr] = None
    requestid: Optional[StrictInt] = None
    approve: Optional[StrictBool] = None
    minutesapproved: Optional[StrictInt] = None
    cancel: Optional[StrictBool] = None
    ncl_only_currentusername: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["username", "requestid", "approve", "minutesapproved", "cancel", "ncl_only_currentusername"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChtwopersonintegrityrequestPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChtwopersonintegrityrequestPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "minutesapproved": obj.get("minutesapproved"),
