...
class ExpandvdisksizeIdPostRequest(BaseModel):
    """
    ...
    rsize: Optional[StrictInt] = None
    copy: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["fmtdisk", "nofmtdisk", "size", "mdisk", "unit", "rsize", "copy"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExpandvdisksizeIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExpandvdisksizeIdPostRequest from a dict"""
        if obj is None:
            return None
