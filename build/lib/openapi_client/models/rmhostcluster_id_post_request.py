...
class RmhostclusterIdPostRequest(BaseModel):
    """
    RmhostclusterIdPostRequest
    """ # noqa: E501
    removeallhosts: Optional[StrictBool] = None
    keepmappings: Optional[StrictBool] = None
    removemappings: Optional[StrictBool] = None
    force: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["removeallhosts", "keepmappings", "removemappings", "force"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RmhostclusterIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RmhostclusterIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "removeallhosts": obj.get("removeallhosts"),
            "keepmappings": obj.get("keepmappings"),
            "removemappings": obj.get("removemappings"),
            "force": obj.get("force")
        })
        return _obj
