...
class ChcloudcallhomePostRequest(BaseModel):
    """
    ChcloudcallhomePostRequest
    """ # noqa: E501
    enable: Optional[StrictBool] = None
    disable: Optional[StrictBool] = None
    sitenantid: Optional[StrictStr] = None
    cleartenant: Optional[StrictBool] = None
    siapikey: Optional[StrictStr] = None
    clearsiapikey: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["enable", "disable", "sitenantid", "cleartenant", "siapikey", "clearsiapikey"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChcloudcallhomePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChcloudcallhomePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "sitenantid": obj.get("sitenantid"),
            "cleartenant": obj.get("cleartenant"),
            "siapikey": obj.get("siapikey"),
            "clearsiapikey": obj.get("clearsiapikey")
        })
        return _obj
