...
class MigratetoimagePostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["vdisk", "mdisk", "mdiskgrp", "threads", "copy", "tier"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MigratetoimagePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MigratetoimagePostRequest from a dict"""
        if obj is None:
            return None
