...
class ChvolumegroupreplicationIdPostRequest(BaseModel):
    """
    ChvolumegroupreplicationIdPostRequest
    """ # noqa: E501
    mode: Optional[StrictInt] = None
    unsuspend: Optional[StrictBool] = None
    checkpoint: Optional[StrictBool] = None
    startrecoverytest: Optional[StrictBool] = None
    stoprecoverytest: Optional[StrictBool] = None
    accessdivergedcopy: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["mode", "unsuspend", "checkpoint", "startrecoverytest", "stoprecoverytest", "accessdivergedcopy"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChvolumegroupreplicationIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChvolumegroupreplicationIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "mode": obj.get("mode"),
            "unsuspend": obj.get("unsuspend"),
            "checkpoint": obj.get("checkpoint"),
            "startrecoverytest": obj.get("startrecoverytest"),
            "stoprecoverytest": obj.get("stoprecoverytest"),
            "accessdivergedcopy": obj.get("accessdivergedcopy")
        })
        return _obj
