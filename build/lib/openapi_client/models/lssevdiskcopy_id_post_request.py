...
class LssevdiskcopyIdPostRequest(BaseModel):
    """
    LssevdiskcopyIdPostRequest
    """ # noqa: E501
    copy: Optional[StrictInt] = None
    filtervalue: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["copy", "filtervalue"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LssevdiskcopyIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LssevdiskcopyIdPostRequest from a dict"""
        if obj is None:
            return None
