...
class RecoverarrayIdPostRequest(BaseModel):
    """
    RecoverarrayIdPostRequest
    """ # noqa: E501
    format: Optional[StrictBool] = None
    validate: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["format", "validate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RecoverarrayIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RecoverarrayIdPostRequest from a dict"""
        if obj is None:
            return None
