...
class LsrcrelationshipcandidatePostRequest(BaseModel):
    """
    LsrcrelationshipcandidatePostRequest
    """ # noqa: E501
    aux: Optional[StrictStr] = None
    master: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["aux", "master"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LsrcrelationshipcandidatePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LsrcrelationshipcandidatePostRequest from a dict"""
        if obj is None:
            return None
