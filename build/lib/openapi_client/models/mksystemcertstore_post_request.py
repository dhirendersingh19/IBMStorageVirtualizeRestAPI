...
class MksystemcertstorePostRequest(BaseModel):
    """
    MksystemcertstorePostRequest
    """ # noqa: E501
    systemsigned: Optional[StrictBool] = None
    externalsigned: Optional[StrictBool] = None
    ...
    scope: Optional[StrictInt] = None
    validity: Optional[StrictInt] = None
    autorenew: Optional[StrictBool] = None
    file: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["systemsigned", "externalsigned", "country", "state", "locality", "org", "orgunit", "commonname", "subjectalternativename", "email", "keytype", "scope", "validity", "autorenew", "file"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MksystemcertstorePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MksystemcertstorePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "systemsigned": obj.get("systemsigned"),
            "externalsigned": obj.get("externalsigned"),
