...
class ChrcrelationshipIdPostRequest(BaseModel):
    """
    ChrcrelationshipIdPostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    consistgrp: Optional[StrictStr] = None
    noconsistgrp: Optional[StrictStr] = None
    noauxchange: Optional[StrictStr] = None
    nomasterchange: Optional[StrictStr] = None
    auxchange: Optional[StrictStr] = None
    masterchange: Optional[StrictStr] = None
    cyclingmode: Optional[StrictStr] = None
    cycleperiodseconds: Optional[StrictStr] = None
    var_global: Optional[StrictStr] = Field(default=None, alias="global")
    metro: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "consistgrp", "noconsistgrp", "noauxchange", "nomasterchange", "auxchange", "masterchange", "cyclingmode", "cycleperiodseconds", "global", "metro"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChrcrelationshipIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChrcrelationshipIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "consistgrp": obj.get("consistgrp"),
            "noconsistgrp": obj.get("noconsistgrp"),
            "noauxchange": obj.get("noauxchange"),
            "nomasterchange": obj.get("nomasterchange"),
            "auxchange": obj.get("auxchange"),
            "masterchange": obj.get("masterchange"),
            "cyclingmode": obj.get("cyclingmode"),
            "cycleperiodseconds": obj.get("cycleperiodseconds"),
