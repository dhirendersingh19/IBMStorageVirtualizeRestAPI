...
class ChthrottleIdPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["bandwidth", "iops", "name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChthrottleIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChthrottleIdPostRequest from a dict"""
        if obj is None:
            return None
