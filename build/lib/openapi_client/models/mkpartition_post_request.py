...
class MkpartitionPostRequest(BaseModel):
    """
    ...
    splitfrompartition: Optional[StrictStr] = None
    sideofpartition: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "replicationpolicy", "draft", "ownershipgroup", "managementportset", "splitfrompartition", "sideofpartition"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkpartitionPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkpartitionPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "splitfrompartition": obj.get("splitfrompartition"),
            "sideofpartition": obj.get("sideofpartition")
        })
        return _obj
