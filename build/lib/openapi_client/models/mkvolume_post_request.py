...
class MkvolumePostRequest(BaseModel):
    """
    MkvolumePostRequest
    """ # noqa: E501
    ...
    iogrp: Optional[StrictStr] = None
    cache: Optional[StrictInt] = None
    udid: Optional[StrictStr] = None
    buffersize: Optional[StrictStr] = None
    warning: Optional[StrictStr] = None
    noautoexpand: Optional[StrictBool] = None
    grainsize: Optional[StrictInt] = None
    unit: Optional[StrictStr] = None
    thin: Optional[StrictBool] = None
    compressed: Optional[StrictBool] = None
    deduplicated: Optional[StrictBool] = None
    volumegroup: Optional[StrictStr] = None
    hasyncrequired: Optional[StrictBool] = None
    preferrednode: Optional[StrictStr] = None
    displayname: Optional[StrictStr] = None
    fromsnapshotid: Optional[StrictStr] = None
    fromsourcevolume: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    fromsourcegroup: Optional[StrictStr] = None
    fromsourceuid: Optional[StrictInt] = None
    snapshot: Optional[StrictStr] = None
    permithaloss: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["name", "pool", "size", "iogrp", "cache", "udid", "buffersize", "warning", "noautoexpand", "grainsize", "unit", "thin", "compressed", "deduplicated", "volumegroup", "hasyncrequired", "preferrednode", "displayname", "fromsnapshotid", "fromsourcevolume", "type", "fromsourcegroup", "fromsourceuid", "snapshot", "permithaloss"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkvolumePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkvolumePostRequest from a dict"""
        if obj is None:
            return None
