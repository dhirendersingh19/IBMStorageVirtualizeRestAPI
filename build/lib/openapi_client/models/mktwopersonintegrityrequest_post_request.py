...
class MktwopersonintegrityrequestPostRequest(BaseModel):
    """
    MktwopersonintegrityrequestPostRequest
    """ # noqa: E501
    minutesrequested: Optional[StrictInt] = None
    ncl_only_currentusername: Optional[StrictStr] = None
    ncl_only_user_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["minutesrequested", "ncl_only_currentusername", "ncl_only_user_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MktwopersonintegrityrequestPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MktwopersonintegrityrequestPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "minutesrequested": obj.get("minutesrequested"),
            "ncl_only_currentusername": obj.get("ncl_only_currentusername"),
            "ncl_only_user_id": obj.get("ncl_only_user_id")
        })
        return _obj
