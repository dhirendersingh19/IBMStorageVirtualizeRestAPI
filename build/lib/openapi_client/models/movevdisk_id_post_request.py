...
class MovevdiskIdPostRequest(BaseModel):
    """
    MovevdiskIdPostRequest
    """ # noqa: E501
    iogrp: Optional[StrictStr] = None
    node: Optional[StrictStr] = None
    nocachingiogrp: Optional[StrictBool] = None
    force: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["iogrp", "node", "nocachingiogrp", "force"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MovevdiskIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MovevdiskIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "iogrp": obj.get("iogrp"),
            "node": obj.get("node"),
            "nocachingiogrp": obj.get("nocachingiogrp"),
            "force": obj.get("force")
        })
        return _obj
