...
class ChvcenterIdPostRequest(BaseModel):
    """
    ChvcenterIdPostRequest
    """ # noqa: E501
    resetvc: Optional[StrictBool] = None
    vasaapi: Optional[StrictInt] = None
    vcguid: Optional[StrictStr] = None
    vcurl: Optional[StrictStr] = None
    type: Optional[StrictInt] = None
    vasauser: Optional[StrictStr] = None
    generationnumber: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["resetvc", "vasaapi", "vcguid", "vcurl", "type", "vasauser", "generationnumber"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChvcenterIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChvcenterIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "resetvc": obj.get("resetvc"),
            "vasaapi": obj.get("vasaapi"),
            "vcguid": obj.get("vcguid"),
            "vcurl": obj.get("vcurl"),
            "type": obj.get("type"),
            "vasauser": obj.get("vasauser"),
