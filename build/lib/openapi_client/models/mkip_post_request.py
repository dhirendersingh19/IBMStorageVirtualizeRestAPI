...
class MkipPostRequest(BaseModel):
    """
    MkipPostRequest
    """ # noqa: E501
    ...
    prefix: Optional[StrictInt] = None
    gw: Optional[StrictStr] = None
    vlan: Optional[StrictInt] = None
    shareip: Optional[StrictBool] = None
    force: Optional[StrictBool] = None
    partition: Optional[StrictStr] = None
    ouid: Optional[StrictStr] = None
    mkmanagementportset: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["node", "port", "portset", "ip", "prefix", "gw", "vlan", "shareip", "force", "partition", "ouid", "mkmanagementportset"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkipPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkipPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "ouid": obj.get("ouid"),
            "mkmanagementportset": obj.get("mkmanagementportset")
        })
        return _obj
