...
class Error(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        if not isinstance(obj, dict):
            #pydantic_core._pydantic_core.ValidationError: 1 validation error for Error
            #Input should be a valid dictionary or instance of Error [type=model_type, input_value='Invalid Username Header', input_type=str]
