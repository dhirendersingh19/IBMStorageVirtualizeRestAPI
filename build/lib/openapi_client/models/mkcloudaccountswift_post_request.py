...
class MkcloudaccountswiftPostRequest(BaseModel):
    """
    MkcloudaccountswiftPostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    keystone: Optional[StrictBool] = None
    containerprefix: Optional[StrictStr] = None
    endpoint: Optional[StrictStr] = None
    tenantname: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["name", "keystone", "containerprefix", "endpoint", "tenantname", "username", "password", "certificate", "encrypt", "upbandwidthmbits", "downbandwidthmbits"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkcloudaccountswiftPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkcloudaccountswiftPostRequest from a dict"""
        if obj is None:
            return None
