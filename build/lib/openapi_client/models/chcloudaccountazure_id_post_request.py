...
class ChcloudaccountazureIdPostRequest(BaseModel):
    """
    ChcloudaccountazureIdPostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    storageaccountname: Optional[StrictStr] = None
    storageaccountkey: Optional[StrictStr] = None
    upbandwidthmbits: Optional[StrictStr] = None
    downbandwidthmbits: Optional[StrictStr] = None
    certificate: Optional[StrictStr] = None
    nocertificate: Optional[StrictBool] = None
    ignorefailures: Optional[StrictBool] = None
    mode: Optional[StrictInt] = None
    importsystem: Optional[StrictStr] = None
    refresh: Optional[StrictBool] = None
    resetusagehistory: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["name", "storageaccountname", "storageaccountkey", "upbandwidthmbits", "downbandwidthmbits", "certificate", "nocertificate", "ignorefailures", "mode", "importsystem", "refresh", "resetusagehistory"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChcloudaccountazureIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChcloudaccountazureIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "upbandwidthmbits": obj.get("upbandwidthmbits"),
            "downbandwidthmbits": obj.get("downbandwidthmbits"),
            "certificate": obj.get("certificate"),
            "nocertificate": obj.get("nocertificate"),
            "ignorefailures": obj.get("ignorefailures"),
            "mode": obj.get("mode"),
            "importsystem": obj.get("importsystem"),
            "refresh": obj.get("refresh"),
            "resetusagehistory": obj.get("resetusagehistory")
        })
        return _obj
