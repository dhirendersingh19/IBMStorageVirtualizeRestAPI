...
class LsdependentvdisksPostRequest(BaseModel):
    """
    ...
    enclosure: Optional[StrictStr] = None
    canister: Optional[StrictStr] = None
    sem: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["node", "controller", "mdisk", "drive", "enclosure", "canister", "sem"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LsdependentvdisksPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LsdependentvdisksPostRequest from a dict"""
        if obj is None:
            return None
