...
class ChsystemlimitsPostRequest(BaseModel):
    """
    ChsystemlimitsPostRequest
    """ # noqa: E501
    limit: Optional[StrictInt] = None
    threshold: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["limit", "threshold"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChsystemlimitsPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChsystemlimitsPostRequest from a dict"""
        if obj is None:
            return None
