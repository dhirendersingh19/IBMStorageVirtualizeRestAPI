...
class AddcontrolenclosurePostRequest(BaseModel):
    """
    AddcontrolenclosurePostRequest
    """ # noqa: E501
    iogrp: Optional[StrictStr] = None
    sernum: Optional[StrictStr] = None
    site: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["iogrp", "sernum", "site"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AddcontrolenclosurePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AddcontrolenclosurePostRequest from a dict"""
        if obj is None:
            return None
