...
class Mkcloudaccountawss3PostRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "accesskeyid", "guitag", "bucketprefix", "secretaccesskey", "region", "encrypt", "recovery", "upbandwidthmbits", "downbandwidthmbits", "type", "endpoint", "certificate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Mkcloudaccountawss3PostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Mkcloudaccountawss3PostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "guitag": obj.get("guitag"),
            "bucketprefix": obj.get("bucketprefix"),
