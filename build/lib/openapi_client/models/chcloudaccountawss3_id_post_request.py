...
class Chcloudaccountawss3IdPostRequest(BaseModel):
    """
    Chcloudaccountawss3IdPostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    accesskeyid: Optional[StrictStr] = None
    secretaccesskey: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["name", "accesskeyid", "secretaccesskey", "upbandwidthmbits", "downbandwidthmbits", "certificate", "nocertificate", "ignorefailures", "mode", "importsystem", "refresh", "resetusagehistory"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Chcloudaccountawss3IdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Chcloudaccountawss3IdPostRequest from a dict"""
        if obj is None:
            return None
