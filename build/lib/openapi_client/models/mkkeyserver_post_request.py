...
class MkkeyserverPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ip", "port", "sslcert", "name", "primary"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkkeyserverPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkkeyserverPostRequest from a dict"""
        if obj is None:
            return None
