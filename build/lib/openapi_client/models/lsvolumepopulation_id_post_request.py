...
class LsvolumepopulationIdPostRequest(BaseModel):
    """
    LsvolumepopulationIdPostRequest
    """ # noqa: E501
    filtervalue: Optional[StrictStr] = None
    unit: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["filtervalue", "unit"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LsvolumepopulationIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LsvolumepopulationIdPostRequest from a dict"""
        if obj is None:
            return None
