...
class RmvolumehostclustermapIdPostRequest(BaseModel):
    """
    RmvolumehostclustermapIdPostRequest
    """ # noqa: E501
    hostcluster: Optional[StrictStr] = None
    makeprivate: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["hostcluster", "makeprivate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RmvolumehostclustermapIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RmvolumehostclustermapIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "makeprivate": obj.get("makeprivate")
        })
        return _obj
