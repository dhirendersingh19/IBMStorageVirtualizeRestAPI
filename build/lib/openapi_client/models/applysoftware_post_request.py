...
class ApplysoftwarePostRequest(BaseModel):
    """
    ApplysoftwarePostRequest
    """ # noqa: E501
    file: Optional[StrictStr] = None
    force: Optional[StrictStr] = None
    abort: Optional[StrictStr] = None
    prepare: Optional[StrictStr] = None
    resume: Optional[StrictStr] = None
    complete: Optional[StrictStr] = None
    pacednext: Optional[StrictStr] = None
    paced: Optional[StrictStr] = None
    delay: Optional[StrictInt] = None
    pause: Optional[StrictStr] = None
    all: Optional[StrictStr] = None
    var_continue: Optional[StrictStr] = Field(default=None, alias="continue")
    purgepatches: Optional[StrictStr] = None
    autoupdate: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["file", "force", "abort", "prepare", "resume", "complete", "pacednext", "paced", "delay", "pause", "all", "continue", "purgepatches", "autoupdate"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApplysoftwarePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApplysoftwarePostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "pacednext": obj.get("pacednext"),
            "paced": obj.get("paced"),
            "delay": obj.get("delay"),
            "pause": obj.get("pause"),
            "all": obj.get("all"),
            "continue": obj.get("continue"),
            "purgepatches": obj.get("purgepatches"),
