...
class ChpartitionIdPostRequest(BaseModel):
    """
    ChpartitionIdPostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    replicationpolicy: Optional[StrictStr] = None
    noreplicationpolicy: Optional[StrictBool] = None
    deletepreferredmanagementcopy: Optional[StrictBool] = None
    preferredmanagementsystem: Optional[StrictStr] = None
    accessstalecopy: Optional[StrictBool] = None
    ...
    migrationaction: Optional[StrictInt] = None
    makedrlink: Optional[StrictBool] = None
    removedrlink: Optional[StrictBool] = None
    remotedrlinkedpartitionuuid: Optional[StrictStr] = None
    remotesystem: Optional[StrictStr] = None
    forceupperlocation: Optional[StrictInt] = None
    locationuuid: Optional[StrictStr] = None
    commit: Optional[StrictBool] = None
    remotesystemreference1: Optional[StrictStr] = None
    remotesystemreference2: Optional[StrictStr] = None
    managementportset: Optional[StrictStr] = None
    nomanagementportset: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["name", "replicationpolicy", "noreplicationpolicy", "deletepreferredmanagementcopy", "preferredmanagementsystem", "accessstalecopy", "publish", "ownershipgroup", "noownershipgroup", "location", "override", "migrationaction", "makedrlink", "removedrlink", "remotedrlinkedpartitionuuid", "remotesystem", "forceupperlocation", "locationuuid", "commit", "remotesystemreference1", "remotesystemreference2", "managementportset", "nomanagementportset"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChpartitionIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChpartitionIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "noreplicationpolicy": obj.get("noreplicationpolicy"),
            "deletepreferredmanagementcopy": obj.get("deletepreferredmanagementcopy"),
            "preferredmanagementsystem": obj.get("preferredmanagementsystem"),
            "accessstalecopy": obj.get("accessstalecopy"),
            ...
            "makedrlink": obj.get("makedrlink"),
            "removedrlink": obj.get("removedrlink"),
            "remotedrlinkedpartitionuuid": obj.get("remotedrlinkedpartitionuuid"),
            "remotesystem": obj.get("remotesystem"),
            "forceupperlocation": obj.get("forceupperlocation"),
            "locationuuid": obj.get("locationuuid"),
            "commit": obj.get("commit"),
            "remotesystemreference1": obj.get("remotesystemreference1"),
            "remotesystemreference2": obj.get("remotesystemreference2"),
            "managementportset": obj.get("managementportset"),
            "nomanagementportset": obj.get("nomanagementportset")
        })
        return _obj
