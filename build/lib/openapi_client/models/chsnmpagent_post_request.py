...
class ChsnmpagentPostRequest(BaseModel):
    """
    ChsnmpagentPostRequest
    """ # noqa: E501
    enable: Optional[StrictStr] = None
    community: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["enable", "community"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChsnmpagentPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChsnmpagentPostRequest from a dict"""
        if obj is None:
            return None
