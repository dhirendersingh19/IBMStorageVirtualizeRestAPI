...
class ChkeyserverisklmPostRequest(BaseModel):
    """
    ChkeyserverisklmPostRequest
    """ # noqa: E501
    devicegroup: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["devicegroup", "sslcert", "nosslcert", "enable", "disable"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChkeyserverisklmPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChkeyserverisklmPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "devicegroup": obj.get("devicegroup"),
