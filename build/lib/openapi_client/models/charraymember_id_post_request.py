...
class CharraymemberIdPostRequest(BaseModel):
    """
    CharraymemberIdPostRequest
    """ # noqa: E501
    member: Optional[StrictInt] = None
    newdrive: Optional[StrictInt] = None
    immediate: Optional[StrictBool] = None
    balanced: Optional[StrictBool] = None
    unbalanced: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["member", "newdrive", "immediate", "balanced", "unbalanced"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CharraymemberIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CharraymemberIdPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "newdrive": obj.get("newdrive"),
            "immediate": obj.get("immediate"),
            "balanced": obj.get("balanced"),
            "unbalanced": obj.get("unbalanced")
        })
        return _obj
