...
class ChauthmultifactorduoPostRequest(BaseModel):
    """
    ...
    integrationkey: Optional[StrictStr] = None
    secretkey: Optional[StrictStr] = None
    disable: Optional[StrictBool] = None
    force: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["enable", "failmode", "hostname", "maxprompts", "openidclientid", "openidclientsecret", "integrationkey", "secretkey", "disable", "force"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChauthmultifactorduoPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChauthmultifactorduoPostRequest from a dict"""
        if obj is None:
            return None
