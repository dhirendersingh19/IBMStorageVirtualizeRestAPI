...
class ChpartitioncertstorePostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["partition", "cancel", "autorenew", "install", "file", "export", "exportrootca"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChpartitioncertstorePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChpartitioncertstorePostRequest from a dict"""
        if obj is None:
            return None
