...
class MkvdiskPostRequest(BaseModel):
    """
    MkvdiskPostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    mdiskgrp: Optional[StrictStr] = None
    fmtdisk: Optional[StrictBool] = None
    nofmtdisk: Optional[StrictBool] = None
    size: Optional[StrictInt] = None
    iogrp: Optional[StrictStr] = None
    vtype: Optional[StrictInt] = None
    mdisk: Optional[StrictStr] = None
    node: Optional[StrictStr] = None
    unit: Optional[StrictStr] = None
    cache: Optional[StrictInt] = None
    udid: Optional[StrictStr] = None
    rsize: Optional[StrictStr] = None
    warning: Optional[StrictStr] = None
    autoexpand: Optional[StrictBool] = None
    ...
    syncrate: Optional[StrictInt] = None
    createsync: Optional[StrictBool] = None
    easytier: Optional[StrictInt] = None
    tier: Optional[StrictInt] = None
    mirrorwritepriority: Optional[StrictInt] = None
    accessiogrp: Optional[StrictStr] = None
    compressed: Optional[StrictBool] = None
    deduplicated: Optional[StrictBool] = None
    displayname: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "mdiskgrp", "fmtdisk", "nofmtdisk", "size", "iogrp", "vtype", "mdisk", "node", "unit", "cache", "udid", "rsize", "warning", "autoexpand", "grainsize", "import", "copies", "syncrate", "createsync", "easytier", "tier", "mirrorwritepriority", "accessiogrp", "compressed", "deduplicated", "displayname"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkvdiskPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkvdiskPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "mdiskgrp": obj.get("mdiskgrp"),
            "fmtdisk": obj.get("fmtdisk"),
            "nofmtdisk": obj.get("nofmtdisk"),
            "size": obj.get("size"),
            "iogrp": obj.get("iogrp"),
            "vtype": obj.get("vtype"),
            "mdisk": obj.get("mdisk"),
            ...
            "autoexpand": obj.get("autoexpand"),
            "grainsize": obj.get("grainsize"),
            "import": obj.get("import"),
            "copies": obj.get("copies"),
            "syncrate": obj.get("syncrate"),
            "createsync": obj.get("createsync"),
            "easytier": obj.get("easytier"),
            "tier": obj.get("tier"),
            "mirrorwritepriority": obj.get("mirrorwritepriority"),
            "accessiogrp": obj.get("accessiogrp"),
