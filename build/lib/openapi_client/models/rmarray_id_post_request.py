...
class RmarrayIdPostRequest(BaseModel):
    """
    RmarrayIdPostRequest
    """ # noqa: E501
    mdisk: Optional[StrictStr] = None
    force: Optional[StrictBool] = None
    enclosure: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["mdisk", "force", "enclosure"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RmarrayIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RmarrayIdPostRequest from a dict"""
        if obj is None:
            return None
