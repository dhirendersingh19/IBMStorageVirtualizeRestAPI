...
class RepairvdiskcopyIdPostRequest(BaseModel):
    """
    RepairvdiskcopyIdPostRequest
    """ # noqa: E501
    medium: Optional[StrictStr] = None
    resync: Optional[StrictStr] = None
    startlba: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["medium", "resync", "startlba"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RepairvdiskcopyIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RepairvdiskcopyIdPostRequest from a dict"""
        if obj is None:
            return None
