...
class CatauditlogPostRequest(BaseModel):
    """
    CatauditlogPostRequest
    """ # noqa: E501
    first: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["first"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CatauditlogPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CatauditlogPostRequest from a dict"""
        if obj is None:
            return None
