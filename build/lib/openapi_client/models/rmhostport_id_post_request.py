...
class RmhostportIdPostRequest(BaseModel):
    """
    RmhostportIdPostRequest
    """ # noqa: E501
    fcwwpn: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["fcwwpn"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RmhostportIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RmhostportIdPostRequest from a dict"""
        if obj is None:
            return None
