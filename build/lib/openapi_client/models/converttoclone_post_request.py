...
class ConverttoclonePostRequest(BaseModel):
    """
    ConverttoclonePostRequest
    """ # noqa: E501
    volumegroup: Optional[StrictStr] = None
    volumes: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["volumegroup", "volumes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConverttoclonePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConverttoclonePostRequest from a dict"""
        if obj is None:
            return None
