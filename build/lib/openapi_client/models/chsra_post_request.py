...
class ChsraPostRequest(BaseModel):
    """
    ChsraPostRequest
    """ # noqa: E501
    enable: Optional[StrictBool] = None
    disable: Optional[StrictBool] = None
    updatetoken: Optional[StrictBool] = None
    remotesupport: Optional[StrictInt] = None
    idletimeout: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["enable", "disable", "updatetoken", "remotesupport", "idletimeout"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChsraPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChsraPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "remotesupport": obj.get("remotesupport"),
