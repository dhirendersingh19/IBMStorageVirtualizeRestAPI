...
class ChauthservicePostRequest(BaseModel):
    """
    ...
    refresh: Optional[StrictStr] = None
    sslcert: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["enable", "url", "username", "password", "refresh", "sslcert", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChauthservicePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChauthservicePostRequest from a dict"""
        if obj is None:
            return None
