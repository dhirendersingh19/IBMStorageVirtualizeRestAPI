...
class ChsyslogserverIdPostRequest(BaseModel):
    """
    ...
    cadf: Optional[StrictStr] = None
    audit: Optional[StrictStr] = None
    login: Optional[StrictStr] = None
    protocol: Optional[StrictStr] = None
    port: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "ip", "facility", "error", "warning", "info", "cadf", "audit", "login", "protocol", "port"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChsyslogserverIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChsyslogserverIdPostRequest from a dict"""
        if obj is None:
            return None
