...
class ChbannerPostRequest(BaseModel):
    """
    ChbannerPostRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["enable", "disable", "clear"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChbannerPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChbannerPostRequest from a dict"""
        if obj is None:
            return None
