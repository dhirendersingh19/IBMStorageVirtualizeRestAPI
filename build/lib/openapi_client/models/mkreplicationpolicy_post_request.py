...
class MkreplicationpolicyPostRequest(BaseModel):
    """
    MkreplicationpolicyPostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    topology: Optional[StrictInt] = None
    rpoalert: Optional[StrictInt] = None
    location1system: Optional[StrictStr] = None
    location1iogrp: Optional[StrictInt] = None
    location2system: Optional[StrictStr] = None
    location2iogrp: Optional[StrictInt] = None
    partition: Optional[StrictStr] = None
    uuid: Optional[StrictStr] = None
    snapshots: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["name", "topology", "rpoalert", "location1system", "location1iogrp", "location2system", "location2iogrp", "partition", "uuid", "snapshots"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkreplicationpolicyPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkreplicationpolicyPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "rpoalert": obj.get("rpoalert"),
            "location1system": obj.get("location1system"),
            "location1iogrp": obj.get("location1iogrp"),
            "location2system": obj.get("location2system"),
            "location2iogrp": obj.get("location2iogrp"),
