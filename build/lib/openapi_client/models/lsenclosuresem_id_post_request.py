...
class LsenclosuresemIdPostRequest(BaseModel):
    """
    LsenclosuresemIdPostRequest
    """ # noqa: E501
    filtervalue: Optional[StrictStr] = None
    sem: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["filtervalue", "sem"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LsenclosuresemIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LsenclosuresemIdPostRequest from a dict"""
        if obj is None:
            return None
