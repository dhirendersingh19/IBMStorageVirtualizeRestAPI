...
class MkippartnershipPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["clusterip", "chapsecret", "linkbandwidthmbits", "backgroundcopyrate", "compressed", "secured", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkippartnershipPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkippartnershipPostRequest from a dict"""
        if obj is None:
            return None
