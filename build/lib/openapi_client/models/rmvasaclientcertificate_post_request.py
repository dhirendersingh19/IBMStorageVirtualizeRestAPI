...
class RmvasaclientcertificatePostRequest(BaseModel):
    """
    RmvasaclientcertificatePostRequest
    """ # noqa: E501
    certuuid: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["certuuid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RmvasaclientcertificatePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RmvasaclientcertificatePostRequest from a dict"""
        if obj is None:
            return None
