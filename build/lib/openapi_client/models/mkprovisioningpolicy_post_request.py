...
class MkprovisioningpolicyPostRequest(BaseModel):
    """
    MkprovisioningpolicyPostRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    capacitysaving: Optional[StrictInt] = None
    deduplicated: Optional[StrictBool] = None
    warning: Optional[StrictStr] = None
    buffersize: Optional[StrictStr] = None
    unit: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "capacitysaving", "deduplicated", "warning", "buffersize", "unit"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkprovisioningpolicyPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkprovisioningpolicyPostRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "capacitysaving": obj.get("capacitysaving"),
