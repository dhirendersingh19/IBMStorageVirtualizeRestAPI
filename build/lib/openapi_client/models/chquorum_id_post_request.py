...
class ChquorumIdPostRequest(BaseModel):
    """
    ChquorumIdPostRequest
    """ # noqa: E501
    active: Optional[StrictStr] = None
    mdisk: Optional[StrictStr] = None
    override: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["active", "mdisk", "override"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ChquorumIdPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ChquorumIdPostRequest from a dict"""
        if obj is None:
            return None
