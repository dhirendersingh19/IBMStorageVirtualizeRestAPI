...
class MkmetadatavdiskPostRequest(BaseModel):
    """
    MkmetadatavdiskPostRequest
    """ # noqa: E501
    mdiskgrp: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["mdiskgrp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MkmetadatavdiskPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MkmetadatavdiskPostRequest from a dict"""
        if obj is None:
            return None
