...
class SetpwdresetPostRequest(BaseModel):
    """
    SetpwdresetPostRequest
    """ # noqa: E501
    disable: Optional[StrictStr] = None
    enable: Optional[StrictStr] = None
    show: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["disable", "enable", "show"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SetpwdresetPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SetpwdresetPostRequest from a dict"""
        if obj is None:
            return None
