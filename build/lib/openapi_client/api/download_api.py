...
class DownloadApi:
    ...
    def download_post(
        self,
        download_post_request: DownloadPostRequest,
        ...
        Downloads a file from a dump location 

        :param download_post_request: (required)
        :type download_post_request: DownloadPostRequest
        :param x_auth_token:
        ...
        _param = self._download_post_serialize(
            download_post_request=download_post_request,
    ...
    @validate_call
    def download_post_with_http_info(
        self,
        download_post_request: DownloadPostRequest,
        x_auth_token: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def download_post_without_preload_content(
        self,
        download_post_request: DownloadPostRequest,
        x_auth_token: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _download_post_serialize(
        ...
        if download_post_request is not None:
            _body_params = download_post_request
